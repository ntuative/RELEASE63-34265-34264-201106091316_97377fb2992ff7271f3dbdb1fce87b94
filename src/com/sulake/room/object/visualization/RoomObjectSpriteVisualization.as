package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_419:IRoomObject;
      
      private var var_776:IGraphicAssetCollection;
      
      protected var var_496:int = -1;
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_776.removeReference();
         }
         this.var_776 = param1;
         if(this.var_776 != null)
         {
            this.var_776.addReference();
         }
      }
      ...
      {
         this.var_496 = 4294967295;
         this.var_160 = 4294967295;
         this.var_100 = -1;
      }
