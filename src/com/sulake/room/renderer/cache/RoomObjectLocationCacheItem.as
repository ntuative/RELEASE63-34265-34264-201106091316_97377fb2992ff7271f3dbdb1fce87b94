package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1713 || param1.getUpdateID() != this.var_2701)
         {
            this.var_2701 = param1.getUpdateID();
            if(param2.updateId != this.var_1713 || _loc4_.x != this.var_1292.x || _loc4_.y != this.var_1292.y || _loc4_.z != this.var_1292.z)
            {
               this.var_1713 = param2.updateId;
               this.var_1292.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2700 = _loc3_;
         if(_loc3_)
         {
