package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_375:int = 50;
      
      private static const const_1395:int = 50;
      
      private static const const_1015:Number = 60;
      
      private static const const_1396:Number = 50;
      ...
      private var var_511:Point;
      
      private var var_265:BitmapDataCache;
      
      private var var_605:RoomObjectCache;
      ...
      private var var_2244:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_264 = new Sprite();
         this.var_264.mouseEnabled = false;
         this.var_108 = new Sprite();
         this.var_108.name = "canvas";
         this.var_108.mouseEnabled = false;
         this.var_264.addChild(this.var_108);
         ...
         this.var_265 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_605 = new RoomObjectCache(_loc6_);
         this.var_821 = new ColorTransform();
         this.var_600 = new Matrix();
      ...
      {
         this.var_511.x -= param1 - this.var_602;
         this.var_602 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_511.y -= param1 - this.var_604;
         this.var_604 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1051 = true;
            if(this.var_143 != null && !this.var_264.contains(this.var_143))
            {
               this.var_264.addChild(this.var_143);
               this.var_108.mask = this.var_143;
            }
         }
         else if(!param1 && this.var_1051)
         {
            this.var_1051 = false;
            if(this.var_143 != null && this.var_264.contains(this.var_143))
            {
               this.var_264.removeChild(this.var_143);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_264.numChildren > 0)
            {
               this.var_264.removeChildAt(0);
            }
            this.var_264 = null;
         }
         this.var_108 = null;
         ...
         if(this.var_601 != null)
         {
            ...
            {
               this.cleanSprite(this.var_601[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_601 = [];
         }
      ...
      {
         this.var_605.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1701 = !this.var_1701;
         ...
         if(this.var_508 != this.var_2241 || this.var_509 != this.var_2243)
         {
            _loc8_ = true;
         }
         if(this.var_108.x != this.var_602 || this.var_108.y != this.var_604)
         {
            this.var_108.x = this.var_602;
            this.var_108.y = this.var_604;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_510.sortOn("z",0 | 0);
         if(_loc5_ < this.var_510.length)
         {
            this.var_510.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_510[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2241 = this.var_508;
         this.var_2243 = this.var_509;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1420 > 0)
         {
            ...
            {
               ++this.var_742;
               if(this.var_742 == const_375 + 1)
               {
                  this.var_539 = _loc2_;
                  this.var_1702 = this.var_2239;
               }
               else if(this.var_742 > const_375 + 1)
               {
                  _loc3_ = Number(this.var_742 - const_375);
                  this.var_539 = this.var_539 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1702 = this.var_1702 * (_loc3_ - 1) / _loc3_ + Number(this.var_2239) / _loc3_;
                  if(this.var_742 > const_375 + const_1395)
                  {
                     this.var_742 = const_375;
                     if(!this.var_1145 && this.var_539 > const_1015)
                     {
                        this.var_1145 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1145 && this.var_539 < const_1396)
                     {
                        this.var_1145 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_605.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_605.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1701 && this.var_1145);
         ...
         _loc13_ += int(this.var_508 / 2);
         _loc14_ += int(this.var_509 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_602;
                  ...
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_510.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_602;
      ...
      {
         if(param1 < this.var_508 && param1 + param3 >= 0 && (param2 < this.var_509 && param2 + param4 >= 0))
         {
            if(!this.var_3003)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_508)
         {
            param3 -= this.var_508 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_509)
         {
            param4 -= this.var_509 + 1 - (param2 + param4);
         }
      ...
      {
         if(param1 < 0 || param1 >= this.var_920)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_601.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_920)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_510.length)
         {
            return null;
         }
         return this.var_510[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_265.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_265.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_265.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_600.identity();
            if(flipH)
            {
               this.var_600.scale(-1,1);
               this.var_600.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_600.scale(1,-1);
               this.var_600.translate(0,data.height);
            }
            finalData.draw(data,this.var_600);
            if(name.length > 0)
            {
               this.var_265.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_687);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_821.redMultiplier = tR;
            this.var_821.greenMultiplier = tG;
            this.var_821.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_821);
            if(name.length > 0)
            {
               this.var_265.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_602;
         param2 -= this.var_604;
         this.var_511.x = param1;
         this.var_511.y = param2;
         if(this.var_1146 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1703;
         }
         this.var_1703 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1146;
         return this.var_1703;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_508 / 2;
         var _loc12_:Number = param2 - this.var_509 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1704,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2244 || param2 != this.var_2238)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      public function update() : void
      {
         if(this.var_1146 == 0)
         {
            this.checkMouseHits(this.var_511.x,this.var_511.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1146 = 0;
         ++this.var_1704;
      }
