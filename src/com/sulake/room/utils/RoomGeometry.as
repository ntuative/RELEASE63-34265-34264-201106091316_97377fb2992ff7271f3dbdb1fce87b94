package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1355:Number = 32;
      ...
      private var var_440:Number = 1.0;
      ...
      private var var_3013:Number = -500.0;
      
      private var var_3012:Number = 500.0;
      ...
      {
         this.var_439.assign(this.var_102);
         this.var_439.x *= this.var_443;
         this.var_439.y *= this.var_440;
         this.var_439.z *= this.var_442;
         return this.var_439;
      }
      ...
      {
         if(this.var_443 != param1 * this.var_1817)
         {
            this.var_443 = param1 * this.var_1817;
            ++this.var_170;
         }
      }
      ...
      {
         if(this.var_440 != param1 * this.var_1815)
         {
            this.var_440 = param1 * this.var_1815;
            ++this.var_170;
         }
      }
      ...
      {
         if(this.var_442 != param1 * this.var_1816)
         {
            this.var_442 = param1 * this.var_1816;
            ++this.var_170;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_102.x /= this.var_443;
         this.var_102.y /= this.var_440;
         this.var_102.z /= this.var_442;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_441.x;
         var _loc3_:Number = this.var_441.y;
         var _loc4_:Number = this.var_441.z;
         this.var_441.assign(param1);
         this._direction.assign(param1);
         if(this.var_441.x != _loc2_ || this.var_441.y != _loc3_ || this.var_441.z != _loc4_)
         {
            ++this.var_170;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_166.assign(_loc25_);
            this.var_1216.assign(this.var_166);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_165.assign(_loc19_);
            this.var_166.assign(_loc20_);
            this.var_1216.assign(this.var_166);
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1215.assign(_loc22_);
         }
         else
         {
            this.var_1215.assign(_loc17_);
         }
         ++this.var_170;
      }
      ...
      {
         if(param1 == null || this.var_166 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_166,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_166);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_440;
         _loc2_.z *= this.var_442;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1215);
         if(_loc3_ < this.var_3013 || _loc3_ > this.var_3012)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_440;
            _loc2_.z *= this.var_442;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1215);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_102.x * this.var_443,this.var_102.y * this.var_440,this.var_102.z * this.var_442);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_166;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_443,param2.y * this.var_440,param2.z * this.var_442);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_443,param3.y * this.var_440,param3.z * this.var_442);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_443,param4.y * this.var_440,param4.z * this.var_442);
