package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected function prepare(param1:String, param2:String, param3:String, param4:String, param5:String, param6:Boolean) : void
      {
         ...
         this._icon = var_1410.create("ICON_" + this.typeCode,WindowType.const_447,WindowStyle.const_139,WindowParam.const_31,Token.ICON_RECTANGLE) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1410.create("BITMAP_" + this.typeCode,WindowType.const_537,WindowStyle.const_139,WindowParam.const_191,Token.ICON_RECTANGLE) as IBitmapWrapperWindow;
