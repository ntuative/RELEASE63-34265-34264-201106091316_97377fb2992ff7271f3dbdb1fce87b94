package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class Tab implements ITab
   {
      ...
      public static var var_1115:IHabboFriendBarData;
      
      public static var var_1384:IHabboFriendBarView;
      
      public static var ASSETS:IAssetLibrary;
      
      public static var WINDOWING:IHabboWindowManager;
      
      public static var var_2187:IHabboLocalizationManager;
      
      public static var var_2183:TextCropper;
      ...
      protected function onMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         if(this.selected)
         {
            var_1384.deSelect(true);
         }
         else
         {
            var_1384.selectTab(this,true);
         }
      }
