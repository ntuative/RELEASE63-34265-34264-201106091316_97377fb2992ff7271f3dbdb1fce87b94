package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_311:Boolean = false;
      
      private static const const_1107:Boolean = false;
      
      private static const const_699:String = "Navigation";
      
      private static const const_698:String = "Friend Bar";
      
      private static const const_1627:String = "go.friendbar";
      
      private static const const_1624:String = "chat_btn_click";
      
      private static const const_1626:String = "find_friends_btn_click";
      
      private static const const_1105:String = "Toolbar";
      
      private static const const_1106:String = "open";
      
      private static const const_1108:String = "close";
      
      private static const const_1625:String = "FRIENDLIST";
      
      private static const const_1628:String = "MESSENGER";
       
      
      private var var_1355:IHabboConfigurationManager;
      
      private var var_91:IHabboCommunicationManager;
      
      private var var_157:IHabboFriendList;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1355)
            {
               this.var_1355.release(new IIDHabboConfigurationManager());
               this.var_1355 = null;
            }
            if(this.var_91)
            {
            ...
            if(this.var_157)
            {
               this.var_157.release(new IIDHabboFriendList());
               this.var_157 = null;
            }
            if(this.var_226)
            {
      ...
      {
         return !!this.var_182 ? int(this.var_182.length) : 0;
      }
      
      public function getFriendRequestAt(param1:int) : FriendRequest
      {
         return !!this.var_182 ? this.var_182[param1] : null;
      }
      ...
      public function acceptFriendRequest(param1:int) : void
      {
         ...
         if(this.var_157)
         {
            if(!this.var_157.disposed)
            {
               this.var_157.acceptFriendRequest(param1);
            }
         }
      }
      ...
      public function declineFriendRequest(param1:int) : void
      {
         ...
         if(this.var_157)
         {
            if(!this.var_157.disposed)
            {
               this.var_157.declineFriendRequest(param1);
            }
         }
      }
      ...
      private function removeFriendRequest(param1:int) : void
      {
         ...
         if(this.var_182)
         {
            for each(_loc2_ in this.var_182)
            {
               if(_loc2_.id == param1)
               {
                  this.var_182.splice(this.var_182.indexOf(_loc2_),1);
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_91)
         {
            ...
            this.var_91.getHabboMainConnection(null).send(new EventLogMessageComposer(const_699,const_698,const_1627));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_226)
         {
            ...
            if(this.var_91)
            {
               this.var_91.getHabboMainConnection(null).send(new EventLogMessageComposer(const_699,const_698,const_1624));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_91)
         {
            ...
            this.var_91.getHabboMainConnection(null).send(new EventLogMessageComposer(const_699,const_698,const_1626));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_157)
         {
            if(!this.var_157.disposed)
            {
               if(!this.var_157.isOpen())
               {
                  if(this.var_182.length > 0)
                  {
                     this.var_157.openFriendRequests();
                  }
                  else
                  {
                     this.var_157.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_157.mainWindow;
               ...
               if(this.var_91)
               {
                  this.var_91.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1105,const_1625,!!this.var_157.isOpen() ? const_1106 : const_1108));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_226)
         {
            if(!this.var_226.disposed)
            {
               ...
               if(this.var_91)
               {
                  this.var_91.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1105,const_1628,!!this.var_226.isOpen() ? const_1106 : const_1108));
               }
            }
         }
      }
      ...
      {
         this.var_1355 = param2 as IHabboConfigurationManager;
         this.var_2913 = this.var_1355.getBoolean("friendbar.notifications.enabled",false);
      }
      ...
      {
         this.var_157 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc6_)
         {
            ...
            else if(_loc4_.online || const_311)
            {
         ...
         {
            this.var_113 = !!const_311 ? this.sortByNameAndOnlineStatus(this.var_113) : this.sortByName(this.var_113);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewFriendRequest(param1:NewBuddyRequestEvent) : void
      {
         ...
         this.var_182.push(new FriendRequest(_loc2_.requestId,_loc2_.requesterName));
         events.dispatchEvent(new FriendRequestEvent());
      }
      ...
      private function onFriendRequestList(param1:BuddyRequestsEvent) : void
      {
         ...
         {
            this.var_182.push(new FriendRequest(_loc3_.requestId,_loc3_.requesterName));
         }
         events.dispatchEvent(new FriendRequestEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_879));
            this.makeNotification(String(this.var_879),FriendNotification.const_422,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_879));
            this.makeNotification(String(this.var_879),FriendNotification.const_422,null,true,false);
         }
      }
