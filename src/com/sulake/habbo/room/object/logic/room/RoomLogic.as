package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_2006:int = 255;
      
      private var var_1573:uint = 16777215;
      
      private var var_2005:int = 255;
      
      private var var_1308:uint = 16777215;
      
      private var var_2004:int = 255;
      
      private var var_1309:int = 0;
      
      private var var_2003:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_615,RoomObjectMouseEvent.const_167];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1340,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_735,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_751,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_752,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1309)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_2006;
            if(_loc2_ - this.var_1309 >= this.var_2003)
            {
               _loc3_ = this.var_1308;
               _loc4_ = this.var_2004;
               this.var_1309 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1308 >> 16 & 255;
               _loc11_ = this.var_1308 >> 8 & 255;
               _loc12_ = this.var_1308 & 255;
               _loc13_ = (_loc2_ - this.var_1309) / this.var_2003;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2005 + (this.var_2004 - this.var_2005) * _loc13_;
               this._color = _loc3_;
               this.var_2006 = _loc4_;
            }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_718:
               param2.setString(RoomObjectVariableEnum.const_220,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_765:
               param2.setString(RoomObjectVariableEnum.const_214,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_843:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_530:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_308)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_808:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1170,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1207:
               param2.setNumber(RoomObjectVariableEnum.const_751,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1347:
               param2.setNumber(RoomObjectVariableEnum.const_752,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_688:
               ...
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1222:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1192,int(param1.bgOnly));
         this.var_1573 = this._color;
         this.var_2005 = this.var_2006;
         this.var_1308 = _loc3_;
         this.var_2004 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_589,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1894,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1895,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1728,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_589,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_241 || _loc12_ == RoomPlaneData.const_423)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
