package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_495,RoomObjectFurnitureActionEvent.const_484,RoomObjectFurnitureActionEvent.const_624,RoomObjectFurnitureActionEvent.const_594,RoomObjectWidgetRequestEvent.const_150];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_888) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_392,RoomWidgetInfostandExtraParamEnum.const_604);
            ...
            if(_loc4_ != this.var_2248)
            {
               this.var_2248 = _loc4_;
               if(_loc4_ == 1)
               {
