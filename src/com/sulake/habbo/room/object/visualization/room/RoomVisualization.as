package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1750:int = 16777215;
      
      public static const const_1860:int = 13421772;
      
      private static const const_1064:int = 16777215;
      
      private static const const_1065:int = 13421772;
      
      private static const const_1066:int = 10066329;
      
      private static const const_1067:int = 10066329;
      
      public static const const_1881:int = 16777215;
      
      public static const const_1884:int = 13421772;
      
      public static const const_1710:int = 10066329;
      ...
      private var var_1905:String = null;
      
      private var var_1261:uint = 16777215;
      
      private var var_2578:int = 255;
      
      private var var_2575:int = 255;
      
      private var var_2576:int = 255;
      
      private var var_1907:Boolean = true;
      
      private var var_1260:int = 0;
      
      private var var_2104:int = -1000;
      
      private const const_2281:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1511))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1511;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1340);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1173);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_241)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_423)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1881;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1884;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1953)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_73,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_2104 + this.const_2281 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_376.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1907)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2576 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2575 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2578 / 255);
         ...
         var_160 = _loc7_.getUpdateID();
         this.var_2104 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1713)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1662 || _loc3_.y != this.var_2577 || _loc3_.z != this.var_2579 || param1.scale != this.var_1906))
            {
               this.var_1662 = _loc3_.x;
               this.var_2577 = _loc3_.y;
               this.var_2579 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_160 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1170);
            if(_loc3_ != this.var_1905)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1905 = _loc3_;
               _loc2_ = true;
            }
            ...
            if(_loc4_ != this.var_1261)
            {
               ...
               this.var_2576 = this.var_1261 & 255;
               this.var_2575 = this.var_1261 >> 8 & 255;
               this.var_2578 = this.var_1261 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1192));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_160 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_214);
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_751));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_752));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_160 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1291);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1210);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1511))
            {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1260;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_73 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_308)
                              {
