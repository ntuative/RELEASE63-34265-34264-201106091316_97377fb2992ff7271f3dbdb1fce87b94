package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_832:WallAdRasterizer;
      
      private var var_560:LandscapeRasterizer;
      
      private var var_831:PlaneMaskManager;
      ...
      public function RoomVisualizationData()
      {
         ...
         this.var_559 = new FloorRasterizer();
         this.var_832 = new WallAdRasterizer();
         this.var_560 = new LandscapeRasterizer();
         this.var_831 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc8_ = _loc3_[0];
            this.var_559.initialize(_loc8_);
         }
         var _loc4_:XMLList = param1.wallAdData;
         if(_loc4_.length() > 0)
         {
            _loc9_ = _loc4_[0];
            this.var_832.initialize(_loc9_);
         }
         var _loc5_:XMLList = param1.landscapeData;
         if(_loc5_.length() > 0)
         {
            _loc10_ = _loc5_[0];
            this.var_560.initialize(_loc10_);
         }
         var _loc6_:XMLList = param1.maskData;
         if(_loc6_.length() > 0)
         {
            _loc11_ = _loc6_[0];
            this.var_831.initialize(_loc11_);
         }
         return true;
      }
