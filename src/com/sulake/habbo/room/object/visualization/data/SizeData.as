package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_889:DirectionData = null;
      
      private var var_298:Map;
      
      private var _colors:Map;
      
      private var var_1370:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_889 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_298 != null)
         {
            ...
            {
               _loc2_ = this.var_298.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_889,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_298.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_889);
            this.defineDirection(_loc3_,_loc8_);
            this.var_298.add(String(_loc7_),_loc3_);
            this.var_2125 = -1;
            this.var_1370 = null;
            _loc5_++;
         }
         ...
         while(_loc4_ < param2.length())
         {
            ...
            switch(_loc8_)
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1269);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         ...
         if(this.var_298.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_298.getKey(_loc5_)) * this.var_1656;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_298.getKey(_loc4_));
         }
         return const_1857;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_298.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_889;
         }
         this.var_2125 = param1;
         this.var_1370 = _loc2_;
         return this.var_1370;
      }
