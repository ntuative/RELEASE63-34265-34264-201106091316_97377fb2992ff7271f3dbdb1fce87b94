package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      {
         if(this.var_2954 == param1 || this.var_96 == null)
         {
            return;
         }
         this.var_96.copyPixels(this._copy,this._copy.rect,new Point(0,0));
         ...
         this.var_96.draw(_loc3_,_loc4_);
      }
   }
}
