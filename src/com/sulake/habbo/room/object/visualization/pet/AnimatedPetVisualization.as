package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1603:String = "head";
      
      private static const const_696:int = 1;
      
      private static const const_1102:int = 1000;
      
      private static const const_1601:String = "pet_experience_bubble_png";
      
      private static const const_1600:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         if(this._animationData.commonAssets != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               this.var_409 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2896)
            {
               this.var_2896 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_160)
         {
            ...
            this.var_1786 = _loc3_.getNumber(RoomObjectVariableEnum.const_269) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_217);
            if(!isNaN(_loc8_))
            {
               this.var_2069 = _loc8_;
            }
            else
            {
               this.var_2069 = direction;
            }
            this.var_1449 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2307 = _loc3_.getNumber(RoomObjectVariableEnum.const_404);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_964);
            if(_loc9_ != this.var_2070)
            {
               this.var_2070 = _loc9_;
               this.var_2895 = this.var_2070.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_409 != null)
         {
            ...
            if(this.var_1449 > 0)
            {
               _loc2_ = param1 - this.var_1449;
               if(_loc2_ < const_1102)
               {
                  this.var_409.alpha = int(Math.sin(_loc2_ / const_1102 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_409.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_409.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_268)
         {
            this.var_268 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_100,param1);
            this.setAnimationForIndex(const_1600,_loc3_);
         }
      ...
      {
         return super.getAdditionalSpriteCount() + const_696;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2895);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_696)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_696))
            {
               if(param2 >= FurnitureVisualizationData.const_540.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_540[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2069);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_100,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1603)
            {
