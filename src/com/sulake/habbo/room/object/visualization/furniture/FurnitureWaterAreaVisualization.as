package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1521:String = "shore";
      ...
      {
         if(this.var_2687 == param1 && this.var_2688 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1521)
            {
               this.var_1965 = _loc2_;
               this.var_2687 = param1;
               this.var_2688 = direction;
               return this.var_1965;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1283.indexOf(_loc2_) < 0)
            {
               this.var_1283.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1964 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_467.length)
         {
            if(this.var_467[_loc5_] == true)
            {
               this.var_1964 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_552 == 0 || this.var_661 == 0)
         {
            ...
            this.var_552 = _loc2_.getNumber(RoomObjectVariableEnum.const_342);
            this.var_661 = _loc2_.getNumber(RoomObjectVariableEnum.const_442);
         }
         this.var_467 = [];
         this.var_662 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_552 * 2 + this.var_661 * 2)
         {
            this.var_467.push(false);
            this.var_662.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_78,getSize(param3),this.var_467,this.var_662,assetCollection);
      }
