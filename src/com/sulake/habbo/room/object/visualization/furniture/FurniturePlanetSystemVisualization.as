package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         if(this.var_295 == null && spriteCount > 0)
         {
         ...
         if(this.var_295 != null)
         {
            ...
            while(_loc3_ < this.var_295.length)
            {
               ...
               _loc2_.update(this._offsetArray,this.var_2881,param1);
               _loc3_++;
            }
