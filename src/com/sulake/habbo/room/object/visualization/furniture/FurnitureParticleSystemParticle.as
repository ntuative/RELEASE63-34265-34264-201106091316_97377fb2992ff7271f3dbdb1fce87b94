package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemParticle
   {
      ...
      public function init(param1:Number, param2:Number, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:int, param8:Boolean = false, param9:Array = null, param10:Boolean = false) : void
      {
         ...
         this.var_2114 = this._x - this._direction.x * param6;
         this.var_2111 = this.var_165 - this._direction.y * param6;
         this.var_2112 = this.var_166 - this._direction.z * param6;
         this.var_582 = 0;
         this.var_1364 = false;
         this.var_1096 = param7;
         this.var_2937 = param8;
         this._frames = param9;
         this.var_2113 = param10;
         this._alphaMultiplier = 1;
         this.var_1678 = 0.5 + Math.random() * 0.5;
      }
      
      public function update() : void
      {
         ++this.var_582;
         if(this.var_582 == this.var_1096)
         {
            this.ignite();
         }
         if(this.var_2113)
         {
            if(this.var_582 / this.var_1096 > this.var_1678)
            {
               this._alphaMultiplier = (this.var_1096 - this.var_582) / (this.var_1096 * (1 - this.var_1678));
            }
         }
      }
      ...
      public function getAsset() : IGraphicAsset
      {
         ...
         {
            return this._frames[this.var_582 % this._frames.length];
         }
         return null;
      }
      ...
      {
         return this.var_582 <= this.var_1096;
      }
      ...
      {
         return [this._x,this.var_165,this.var_166].toString();
      }
   }
}
