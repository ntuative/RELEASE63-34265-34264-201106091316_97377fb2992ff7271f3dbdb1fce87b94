package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1620:String = "branded_image";
      
      private static const const_1623:int = 0;
      
      private static const const_1619:int = 1;
      
      private static const const_1622:int = 2;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(!this.var_1403)
         {
            this.var_1403 = this.checkIfImageReady();
            if(this.var_1403)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_593);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1620)
         {
