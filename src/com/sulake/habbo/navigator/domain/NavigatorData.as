package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private static const const_2005:int = 10;
      ...
      private var var_639:RoomEventData;
      ...
      public function set categories(param1:Array) : void
      {
         ...
         this.var_1496 = new Array();
         for each(_loc2_ in this.var_1497)
         {
            if(_loc2_.visible)
            {
      ...
      {
         return this.var_1495 >= this.var_2508;
      }
