package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_327:MainViewCtrl;
      
      private var var_678:RoomInfoViewCtrl;
      
      private var var_1310:RoomCreateViewCtrl;
      ...
      private var var_2499:RoomThumbnailRenderer;
      
      private var var_936:GuestRoomPasswordInput;
      
      private var var_332:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_327 = new MainViewCtrl(this);
         this.var_678 = new RoomInfoViewCtrl(this);
         this.var_1310 = new RoomCreateViewCtrl(this);
         this.var_2499 = new RoomThumbnailRenderer(this);
         this.var_936 = new GuestRoomPasswordInput(this);
         this.var_332 = new GuestRoomDoorbell(this);
         this.var_465 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_361,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_327.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_202.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_327.startSearch(Tabs.const_213,Tabs.const_399,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_327.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_327.startSearch(Tabs.const_288,Tabs.const_303);
         this.var_465.getTab(Tabs.const_288).tabPageDecorator.tabSelected();
      }
