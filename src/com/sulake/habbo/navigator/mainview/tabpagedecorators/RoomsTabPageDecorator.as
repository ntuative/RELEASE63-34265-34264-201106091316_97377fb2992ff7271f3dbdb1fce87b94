package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_396);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_807);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_396,"" + _loc3_);
         }
         if(this.var_148)
         {
