package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_473 = new Timer(500,1);
         this.var_391 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1126 = param4;
         this.var_2294 = param2;
         this._popupIndentLeft = param3;
         this.var_473.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_473)
         {
            this.var_473.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_473.reset();
            this.var_473 = null;
         }
         if(this.var_391)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_60 == null)
         {
            this.var_60 = IWindowContainer(this._navigator.getXmlWindow(this.var_1126));
         ...
         this.var_60.x = _loc2_.x + this.var_2294 + param1.width;
