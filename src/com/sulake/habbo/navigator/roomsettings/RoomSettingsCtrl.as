package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_749:ICheckBoxWindow;
      
      private var var_1753:ITextWindow;
      
      private var var_940:IDropMenuWindow;
      
      private var var_938:IDropMenuWindow;
      
      private var var_2330:IWindowContainer;
      ...
      {
         if(param1 != this.var_363 || this.var_1161 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1161 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1802)
         {
            this.var_751.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1757)
         {
            this.var_751.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1829)
         {
            this.var_1167.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1801)
         {
            this.setTagError(this.var_937,param3,"${navigator.roomsettings.unacceptablewords}");
         ...
         {
            this.setTagError(this.var_937,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_939,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1675)
         {
            this.var_936.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_751.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_532,this.onDoorModePasswordUnselect);
         ...
         this.var_751 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1167 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_937 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_939 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_936 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1169 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1164 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1168 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1162 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_749 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1753 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_940 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_938 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2330 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1166 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1165 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1751 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1429 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_235 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1163 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1430 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1430.mouseThreshold = 0;
         this.var_1430.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1163.visible = false;
         if(!this.var_1431)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1751.visible = this.var_1431;
         this.populateForm();
         if(this.var_750)
         {
            this.var_1165.visible = true;
            this.var_1429.visible = true;
            this.refreshFlatControllers();
            this.var_1165.height = Util.getLowestPoint(this.var_1165) + 4;
         }
         else
         {
            this.var_1166.visible = true;
            this.var_1429.visible = true;
            this.var_2330.visible = this.var_1431;
            this.var_1166.height = Util.getLowestPoint(this.var_1166) + 4;
         }
         this.var_1430.text = !!this.var_750 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1166.name,this.var_1165.name,this.var_1429.name,this.var_1751.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_751.setText(_loc1_.name);
         this.var_1167.setText(_loc1_.description);
         this.var_936.setText("");
         this.var_1169.setText("");
         ...
         switch(_loc1_.doorMode)
         {
            case RoomSettingsData.const_230:
               ...
               break;
            case RoomSettingsData.const_136:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_136);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_937,_loc1_.tags[0]);
         this.setTag(this.var_939,_loc1_.tags[1]);
         if(this.var_1164)
         {
            if(_loc1_.allowPets)
            {
               this.var_1164.select();
            }
            else
            {
               this.var_1164.unselect();
            }
         }
         if(this.var_1168)
         {
         ...
         if(this.var_1162)
         {
            ...
            {
               this.var_1162.select();
            }
            else
            {
               this.var_1162.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_749);
            this.disableWindow(this.var_940);
            this.disableWindow(this.var_938);
            this.disableWindow(this.var_1753);
         }
         else
         {
            this.enableWindow(this.var_749);
            this.enableWindow(this.var_940);
            this.enableWindow(this.var_938);
            this.enableWindow(this.var_1753);
         }
         if(this.var_749)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_749.unselect();
            }
         }
         if(this.var_940)
         {
            this.var_940.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_938)
         {
            this.var_938.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_751.getText();
         _loc2_.description = this.var_1167.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_136;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_640;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_136)
         {
            _loc8_ = this.var_936.getText();
            _loc9_ = this.var_1169.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_936.clearErrors();
               this.var_1169.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1164.isSelected;
         _loc2_.allowFoodConsume = this.var_1168.isSelected;
         _loc2_.allowWalkThrough = this.var_1162.isSelected;
         _loc2_.hideWalls = this.var_749.isSelected;
         _loc2_.wallThickness = this.var_940.selection - 2;
         _loc2_.floorThickness = this.var_938.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_937,_loc2_.tags);
         this.addTag(this.var_939,_loc2_.tags);
         this.clearErrors();
         this.var_1161 = _loc2_.roomId;
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_75,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
