package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_373:AdImageRequest;
      
      private var var_1235:BitmapData = null;
      
      private var var_1234:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2490 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2493 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2492 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1852 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1852 > 0 && this.var_1851 >= this.var_1852)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1233;
         if(_loc1_ > this.var_2493)
         {
            ++this.var_1851;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1491 = _loc2_.imageUrl;
         this.var_2491 = _loc2_.clickUrl;
         this.var_1233 = getTimer();
         if(this.var_1491 != "")
         {
            _loc3_ = this.var_1491;
            ...
            {
               this.var_239 = new Timer(this.var_2492,1);
            ...
            this.var_239.start();
            _loc4_ = new URLRequest(this.var_1491);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_535,param1.bitmapData,this.var_2491));
            this.var_1233 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_507));
         }
      }
      
      public function showRoomAd(param1:int, param2:int) : void
      {
         this.var_373 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_373 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_373 = new AdImageRequest(this.var_373.roomId,this.var_373.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_373 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_634,this.var_373.roomId,this.var_373.roomCategory,_loc4_,_loc2_.assetName,this.var_373.clickURL,this.var_1235,this.var_1234));
            this.var_373 = null;
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1234 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
