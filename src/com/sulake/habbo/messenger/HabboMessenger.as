package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_451:Conversations;
      
      private var var_194:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_202 && this._localization && this._friendList && this.var_885 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_451 = new Conversations(new ConversationsDeps(this));
         this.var_194 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_451.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_451.setSelected(_loc2_);
            this.var_194.openMessenger();
            this.var_194.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_451 ? this.var_451.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_451.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_451.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_194 && this.var_194.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_194)
         {
            if(this.var_194.isMessengerOpen())
            {
               this.var_194.close();
            }
            else
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_202.getKey("url.prefix",_loc2_);
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_776,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1321,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_451.addMessageAndUpdateView(param1);
         if(!this.var_194.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1329);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1297,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_451.addMessageAndUpdateView(_loc3_);
      }
