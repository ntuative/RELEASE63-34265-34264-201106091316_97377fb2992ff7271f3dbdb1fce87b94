package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1670:uint = 12247545;
      
      private static const const_1668:String = "HELP";
      
      private static const const_1669:String = "ROOMINFO";
      ...
      private var var_371:IWindow;
      
      private var var_724:IWindowContainer;
      
      private const const_889:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_371 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_65.removeListItem(this.var_371);
      }
      
      public function showRoomInfo() : void
      {
         this.var_65.addListItemAt(this.var_371,0);
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_724)
         {
            this.var_724 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1668);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1669);
               break;
            case "confirm":
               if(false)
               {
