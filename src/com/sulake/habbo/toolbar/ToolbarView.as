package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1500:Point = new Point(3,3);
      ...
      private static const const_471:String = "_normal";
      
      private static const const_1068:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1500;
         ...
         {
            this.setIconHoverState(_loc11_,const_471);
         }
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_771:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_858:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_470 ? this.var_1602 : this.var_1601;
         }
         else
         {
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1601 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1602)
         {
            this.var_1602.dispose();
         }
         this.var_1602 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1065.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_1068;
            _loc2_.y = const_1068;
