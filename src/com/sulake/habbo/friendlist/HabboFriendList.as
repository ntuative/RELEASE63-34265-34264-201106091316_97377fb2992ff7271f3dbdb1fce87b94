package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_658.stop();
            this.var_658.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_658 = null;
         }
         ...
         if(this.var_1047)
         {
            this.var_1047.release(new IIDHabboNotifications());
            this.var_1047 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_813)
         {
            this.var_813.release(new IIDSessionDataManager());
            this.var_813 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1960 = new OpenedToWebPopup(this);
         }
         this.var_1960.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_415);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_361,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_885.createAvatarImage(param1,AvatarScaleType.const_112,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_202.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_202.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_1047 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_182 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_114.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_1147,this.getText("friendlist.friends")));
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_398,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_114.addFriend(new Friend(_loc4_));
         }
         this.var_465 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_658)
         {
            this.var_658 = new Timer(120000);
            this.var_658.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_658.start();
         }
         ...
         {
            _loc5_ = this.var_114.findCategory(FriendCategory.const_398);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_182.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_182.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_465.findTab(FriendListTab.const_102).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_182.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_465.findTab(FriendListTab.const_102);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1959.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_465.findTab(FriendListTab.const_102);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_813 || !this.var_182)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_813.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this.var_182.vipLimit;
         }
         else if(this.var_813.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_38))
         {
            _loc2_ = this.var_182.clubLimit;
         }
         if(_loc2_ > this.var_182.limit)
         {
            this.var_182.limit = _loc2_;
         }
      }
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_175) as IBitmapWrapperWindow;
