package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2034:String = "no_reqs_info";
      ...
      private var var_2150:IContainerButtonWindow;
      
      private var var_2151:IContainerButtonWindow;
      ...
      {
         this.var_2150 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2151 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2151.procedure = this.onDismissAllButtonClick;
         this.var_2150.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_177)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_434;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_421;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_340,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_434 && _loc4_.state != FriendRequest.const_421)
            {
               _loc4_.state = FriendRequest.const_421;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_340,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_434 && _loc4_.state != FriendRequest.const_421)
            {
               ...
               _loc4_.state = FriendRequest.const_434;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2150,_loc1_);
         this.setEnabled(this.var_2151,_loc1_);
      }
