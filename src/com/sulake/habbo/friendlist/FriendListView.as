package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1500:Point = new Point(110,50);
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1500;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1013 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_284 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1891.prepare(this.var_1013);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1270,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1331,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_1003,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_828,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1003,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_828,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1504 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1504.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1892 == -1 ? 0 : int(this.var_17.height - this.var_1892);
         var _loc4_:int = this.var_1893 == -1 ? 0 : int(this.var_17.width - this.var_1893);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_284.y = Util.getLowestPoint(this.var_17.content);
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1003,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1270,false);
         ...
         this.var_1892 = this.var_17.height;
         this.var_1893 = this.var_17.width;
