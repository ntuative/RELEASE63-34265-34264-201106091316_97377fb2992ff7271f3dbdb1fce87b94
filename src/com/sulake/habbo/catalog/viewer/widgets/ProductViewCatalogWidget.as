package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1500:IScrollbarWindow;
      
      protected var var_2130:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_987 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1247 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_193 != null)
         {
            ...
            this.var_541 = this.var_193.findChildByName("room_canvas") as IDisplayObjectWrapper;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_987.text = _loc4_;
         this.var_1247.text = _loc5_;
         this.var_987.height = this.var_987.textHeight + 5;
         this.var_1247.y = this.var_987.y + this.var_987.height;
         this.var_1247.height = Math.max(130,this.var_1247.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_505:
                  ...
                  if(this.var_542 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_542,this.var_1500,this.var_2130);
               ...
               case Offer.const_419:
                  ...
                  if(this.var_193 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_77 || _loc9_.productType == ProductTypeEnum.const_62 || _loc9_.productType == ProductTypeEnum.const_187)
                     {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_359,AvatarAction.const_658);
                                 _loc18_.appendAction(AvatarAction.const_341,_loc9_.productClassId);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         for each(_loc6_ in param2.getSprites())
         {
            ...
            _loc12_ = _loc6_.method_2(param2.getDirection());
            _loc13_ = 0;
            if(!param5)
            {
               if(_loc12_ >= 0)
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_95 != null && true)
         {
            ...
            this.var_95.x = this.var_1878.x;
            this.var_95.y = this.var_1878.y;
            if(param3 != null)
            {
