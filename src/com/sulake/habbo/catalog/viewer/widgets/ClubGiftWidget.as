package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_28.purse.pastVipDays >= this.const_239 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_28.purse.pastVipDays % this.const_239;
            _loc4_ = this.var_28.purse.pastVipDays / this.const_239;
            this.var_28.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_28.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_245)
         {
            this.var_245 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_245)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_245.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_245.setGlobalPosition(_loc6_.subtract(new Point(this.var_245.width / 2,this.var_245.height / 2)));
         this.var_245.visible = true;
         this.var_245.activate();
      }
