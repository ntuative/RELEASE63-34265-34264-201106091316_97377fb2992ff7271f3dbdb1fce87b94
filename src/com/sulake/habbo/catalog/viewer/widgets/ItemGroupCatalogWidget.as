package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_210[this.var_518][this.var_708];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_518 = var_501.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_518];
         var _loc3_:Array = this.var_210[this.var_518] as Array;
      ...
      {
         var _loc2_:Array = this.var_210[this.var_518] as Array;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_210[this.var_518] as Array;
         ...
         for each(_loc1_ in page.offers)
         {
            if(_loc1_.pricingModel == Offer.const_412 || _loc1_.pricingModel == Offer.const_419)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_62 || _loc3_.productType == ProductTypeEnum.const_77)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_210[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
