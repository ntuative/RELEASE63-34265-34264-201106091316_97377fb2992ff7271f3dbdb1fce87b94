package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1510:int = 16763904;
      
      private static const const_1511:int = 13421772;
      
      private static const const_1512:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_278.getWithIndex(this.var_320);
         if(_loc4_ != null)
         {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1510);
         _loc2_.push(const_1511);
         _loc2_.push(const_1512);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_278.getWithIndex(this.var_320);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_320;
         if(this.var_320 >= this.var_278.length)
         {
            this.var_320 = 0;
         }
         var _loc2_:Map = this.var_278.getWithIndex(this.var_320);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_320 < 0)
         {
            this.var_320 = this.var_278.length - 1;
         }
         var _loc2_:Map = this.var_278.getWithIndex(this.var_320);
         if(_loc2_ != null)
         {
