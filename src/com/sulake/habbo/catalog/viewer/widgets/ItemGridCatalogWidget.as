   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_810 >= 0 && this.var_810 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_810];
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2130) as IWindowContainer;
         ...
         if(param1.pricingModel == Offer.const_505)
         {
            ++this.var_1942;
