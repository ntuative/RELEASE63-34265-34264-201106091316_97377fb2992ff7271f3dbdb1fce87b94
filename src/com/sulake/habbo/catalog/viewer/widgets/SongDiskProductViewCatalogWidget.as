package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      public function SongDiskProductViewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         ...
         this.var_1151 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         ...
         this.var_1150 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1150 != null)
         {
            this.var_1150.visible = false;
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_133);
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_219);
            this._soundManager.musicController.playSong(this.var_924,HabboMusicPrioritiesEnum.const_219,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_924 = parseInt(_loc2_.extraParam);
            if(this.var_1150 != null)
            {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1151.text = _loc8_;
            }
         }
         else if(this.var_1151 != null)
         {
            this.var_1151.text = "";
         }
         if(this.var_463 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_924);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_924);
         }
         return -1;
      }
