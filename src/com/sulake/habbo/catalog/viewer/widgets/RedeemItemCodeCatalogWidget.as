package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1102.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1102 = null;
         }
         if(this.var_1103 != null)
         {
            this.var_1103.removeEventListener(WindowKeyboardEvent.const_229,this.windowKeyEventProcessor);
            this.var_1103 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1102 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1102 != null)
         {
            this.var_1102.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1103 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1103 != null)
         {
            this.var_1103.addEventListener(WindowKeyboardEvent.const_229,this.windowKeyEventProcessor);
         }
         return true;
      }
