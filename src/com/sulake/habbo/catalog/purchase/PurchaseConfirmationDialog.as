package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2295:int = 10;
      ...
      private const const_2018:uint = 4.293848814E9;
      
      private const const_2017:uint = 4.294967295E9;
      
      private const const_1670:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1327 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_339,this.onNameInputKeyUp);
         }
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_357,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_518,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1716 = _loc1_.stuffTypes;
            this.var_854 = _loc1_.boxTypes;
            this.var_852 = _loc1_.ribbonTypes;
            this.var_1328 = this.var_1716[0];
            this.var_398 = this.var_854[0];
            this.var_396 = this.var_852[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_396 < 0)
         {
            this.var_396 = this.var_852.length - 1;
         }
         if(this.var_396 > this.var_852.length - 1)
         {
            this.var_396 = 0;
         }
         if(this.var_398 < 0)
         {
            this.var_398 = this.var_854.length - 1;
         }
         if(this.var_398 > this.var_854.length - 1)
         {
            this.var_398 = 0;
         }
         var _loc1_:int = this.var_854[this.var_398] * 1000 + this.var_852[this.var_396];
         if(this._window == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1716)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_854[this.var_398]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_852[this.var_396]);
         this._catalog.purchaseProductAsGift(this.var_1588,this.var_1327,this.var_1589,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1588,this.var_1327,this.var_1589);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2798 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_253)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2295)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2798 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_397 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_397 + 1);
               break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_397) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_853 == null)
         {
            this.var_853 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_288 == null || this.var_853 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_853.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_397) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_397);
         }
         this.var_397 = param1;
         if(this.var_397 < 0)
         {
            this.var_397 = _loc2_.numListItems - 1;
         }
         if(this.var_397 >= _loc2_.numListItems)
         {
            this.var_397 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_397) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1670;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2018) : uint(this.const_2017);
      }
