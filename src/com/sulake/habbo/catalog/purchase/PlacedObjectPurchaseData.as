package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_2067:IProductData;
      ...
      {
         this.var_1327 = param1.offerId;
         this.var_2068 = param1.productContainer.firstProduct.productClassId;
         this.var_2067 = param1.productContainer.firstProduct.productData;
         this.var_634 = param1.productContainer.firstProduct.furnitureData;
         this.var_1589 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_232,this._category,this.var_2153,this._x,this.var_165,this._direction,this.var_1327,this.var_2068].toString();
      }
