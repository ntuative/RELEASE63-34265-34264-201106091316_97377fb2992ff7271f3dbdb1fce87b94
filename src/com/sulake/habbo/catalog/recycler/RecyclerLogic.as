package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_704 != const_1091;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2047 != RecyclerStatusMessageEvent.const_1354;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_704 == const_472;
      }
      ...
      {
         this.var_704 = const_1092;
         this.var_134 = new Array(const_203);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_203)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_704 = const_1091;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2047)
         {
            case RecyclerStatusMessageEvent.const_1786:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1354:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1896:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1200:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1960:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_134.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_203)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_134.length < const_203)
         {
            return false;
         }
         var _loc1_:int = 0;
