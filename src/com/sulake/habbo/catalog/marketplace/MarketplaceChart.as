package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_606)
            {
               this.var_606 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_606).toString().length - 1);
         this.var_606 = Math.ceil(this.var_606 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_606.toString();
         _loc3_.draw(_loc6_);
      ...
      {
         return this.var_1149 + this.var_1149 / -this.var_3004 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_923 - this.var_923 / this.var_606 * this.var_165[param1];
      }
