package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3046:String = "magic.credits";
      
      private var var_3024:String = "magic.pixels";
      
      private var var_3025:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_936,this.activateScrollbar);
            ...
            this._scrollBar.addEventListener(WindowEvent.const_287,this.deActivateScrollbar);
         }
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_387.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_387)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_387.indexOf(_loc6_);
            this.var_387.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      private function openNavigatorAtNode(param1:ICatalogNode) : void
      {
         ...
         for each(_loc2_ in this.var_387)
         {
            _loc2_.deActivate();
            _loc2_.close();
         }
      ...
      {
         this.openPage(this.var_3024);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3025,true);
      }
