package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1520:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1536:XML;
      
      private static var var_1537:XML;
       
      
      private var var_1962:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1962 == 4294967295)
            {
               this.var_1962 = _loc1_.color;
            }
            _loc1_.color = const_1520;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1920;
            }
         }
      }
      ...
      {
         this.var_65 = navigator.catalog.windowManager.buildFromXML(var_1537) as IItemListWindow;
         if(this.var_65 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1536) as IWindowContainer;
         }
         else
         {
