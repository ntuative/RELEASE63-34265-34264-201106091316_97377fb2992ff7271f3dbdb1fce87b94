package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private var var_1285:IRoomSession;
      ...
      private var var_230:ChargeConfirmationDialog;
      ...
      private var var_2950:Boolean = true;
      
      private var var_2140:Boolean = false;
      
      private var var_2949:GiftWrappingConfiguration;
      
      private var var_1374:ClubGiftController;
      
      private var var_587:ClubBuyController;
      
      private var var_895:Map;
      
      private var var_1375:Boolean = false;
      
      private var var_893:IPurchasableOffer;
      
      private var var_1661:IDragAndDropDoneReceiver;
      
      private var var_67:PlacedObjectPurchaseData;
      
      private var var_720:RoomPreviewer;
      
      private const const_2009:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_72,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1700);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_207.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_587.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         if(this._roomEngine != null && this.var_202 != null && this.var_202.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_720 == null)
            {
               this.var_720 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_415.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_202.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_202.getKey("link.format.credits","/credits");
      ...
      {
         var _loc2_:Array = this.var_895.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_415 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_707) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2009;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_266,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_72:
               this.var_2140 = param1.session.isPrivateRoom;
               this.var_1285 = param1.session;
               if(this.var_105 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1374 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_587 == null)
         {
            this.var_587 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_415.buildCatalogIndex(_loc2_);
         if(this.var_894 && this.var_894 != "")
         {
            this.var_415.openPage(this.var_894);
            this.var_894 = "";
            this.var_1107 = -1;
         }
         else if(this.var_1107 > -1)
         {
            this.var_415.openPageById(this.var_1107,this.var_2139);
            this.var_1107 = -1;
            this.var_2139 = -1;
            this.var_894 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1212);
         }
         this.var_2951 = false;
         if(this.var_230 != null && !this.var_230.disposed)
         {
            this.var_230.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_70,this.var_119.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2950 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1315);
         }
         this.var_2950 = false;
         if(this.var_230 != null && !this.var_230.disposed)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1374.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2949 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_230 == null || this.var_230.disposed)
         {
            this.var_230 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_230.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_895.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_895.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_202.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_202.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_194)
         {
            _loc3_ = this.var_202.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_202.keyExists("catalog.drag_and_drop") || this.var_202.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1285 || !this.var_1285.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1375 && param1.type == RoomEngineObjectEvent.const_148)
         {
            this.resetPlacedOfferData(true);
            if(this.var_893 == null || this.var_893.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_893.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_67 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_893);
            _loc5_ = this.var_1661;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_315,0.5);
            }
         }
      }
            ...
            if(this.var_67.roomCategory == this._roomEngine.activeRoomCategory && this.var_67.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  ...
                  case FurniCategory.const_337:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_214);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_202.getKey("image.library.catalogue.url");
      ...
      public function update(param1:uint) : void
      {
         if(this.var_720 != null)
         {
            this.var_720.updatePreviewRoomView();
         }
      }
   }
}
