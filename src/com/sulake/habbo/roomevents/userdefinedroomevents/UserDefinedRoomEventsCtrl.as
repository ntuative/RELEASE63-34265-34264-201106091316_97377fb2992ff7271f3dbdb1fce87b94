package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1657:int = 2;
      ...
      private var var_2134:TriggerConfs;
      
      private var var_2135:ActionTypes;
      
      private var var_2133:ConditionTypes;
      
      private var var_299:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_890:RoomObjectHightLighter;
      
      private var var_203:UserDefinedRoomEventsHelp;
      
      private var var_1372:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2134 = new TriggerConfs();
         this.var_2135 = new ActionTypes();
         this.var_2133 = new ConditionTypes();
         this.var_299 = new Dictionary();
         super();
         this.var_92 = param1;
         this.var_890 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1372 = new SliderWindowController(this.var_92,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_92.assets,0,20,1);
         this.var_1372.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1372.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_890.hideAll(this.var_299);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_890.showAll(this.var_299);
         if(this.var_38 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_38);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1372.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1372.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1657) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1657 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2134);
         this.refreshConfigureElement(this.var_2135);
         this.refreshConfigureElement(this.var_2133);
