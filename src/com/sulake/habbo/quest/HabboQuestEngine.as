package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1568:int = 800;
      
      private static const const_1569:int = 15;
      
      private static const const_1570:int = 300;
      ...
      private var var_1335:QuestController;
      
      private var var_1062:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1335 = new QuestController(this);
         this.var_1062 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1571);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_414.events.removeEventListener(BadgeImageReadyEvent.const_114,this.var_1062.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_414.events.addEventListener(BadgeImageReadyEvent.const_114,this.var_1062.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_1335.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1062.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1335.questTracker.isVisible();
      }
