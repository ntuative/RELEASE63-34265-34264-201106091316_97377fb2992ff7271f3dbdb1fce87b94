package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1390:int = 5;
      
      private static const const_1389:int = 10;
      
      private static const const_1392:int = 10;
      
      private static const const_1391:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_737 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_737.toggle();
         this.var_1690 = false;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_65.spacing = const_1389;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1392;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1390;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1391;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1690 && !this.var_1691)
            {
               this.var_1690 = false;
