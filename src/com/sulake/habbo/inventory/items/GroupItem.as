package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1470:int = 10275685;
      ...
      protected var var_2982:BitmapData;
      
      private var var_1471:Boolean;
      
      private const const_2002:Number = 1;
      
      private const const_2003:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2453 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_2982 = param6;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2203 == FurniModelCategory.const_35)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1414));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2199);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_745)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2003;
               _loc1_.blend = this.const_2003;
            }
            else
            {
               this._window.blend = this.const_2002;
               _loc1_.blend = this.const_2002;
            }
         }
         this.var_1439.color = !!this.var_1471 ? uint(const_1470) : uint(const_1471);
         this.var_2453.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2204 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2982;
               _loc5_.visible = true;
            }
            else
            {
