package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_43:
               this.var_1528.setSelectedGridItem(this);
               this.var_1527 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1527 = false;
                  this.var_1528.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1439)
         {
            return;
         }
         this.var_1439.color = !!this.var_1593 ? uint(const_1470) : uint(const_1471);
         this.var_2453.visible = param1;
      }
