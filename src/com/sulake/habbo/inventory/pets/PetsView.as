package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1990:int = 0;
      
      private const const_1019:int = 1;
      
      private const const_1020:int = 2;
      
      private const const_1016:int = 3;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_49)
         {
            ...
            {
               case "tab_floor":
                  this.var_76.switchToFurnitureCategory(FurniModelCategory.const_35);
                  break;
               case "tab_wall":
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1019;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1020;
         }
         else
         {
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_76.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_407) > 0;
