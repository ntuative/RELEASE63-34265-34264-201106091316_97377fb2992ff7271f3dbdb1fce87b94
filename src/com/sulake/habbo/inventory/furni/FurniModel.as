package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1482:int = 100;
      
      private static const const_1481:int = 1000;
      ...
      private var var_1485:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_446 = [];
         this.var_445 = [];
         this.var_635 = new Timer(const_1482,1);
         this.var_635.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2474 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_635.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_635.stop();
               this.var_635 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_35)
            {
               ...
               {
                  this.var_1485 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1485;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_788 == null)
         {
            this.var_788 = this._windowManager.buildFromXML(this.var_2474) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_788.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_788.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_35,const_44];
         var _loc5_:int = 0;
         ...
         if(param1 == InventoryCategory.const_78 && this.var_28.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_264:
                  this.var_28.toggleInventoryPage(InventoryCategory.const_127);
            }
         }
      }
      ...
      {
         this.var_2473 = getTimer();
         this.switchCategory(const_264);
      }
      ...
      {
         this.var_28.checkCategoryInitilization(InventoryCategory.const_406);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_35,const_44];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_35,const_44];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_634.add(const_35,new Array());
         this.var_634.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_35;
            _loc5_ = this.var_446.indexOf(param1.ref) > -1;
         }
         else
         {
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_231)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_264)
            {
      ...
      {
         return getTimer() < this.var_2473 + const_1481;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_351 || _loc3_.category == FurniCategory.const_337 || _loc3_.category == FurniCategory.const_323)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_634.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_745)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_446.indexOf(_loc2_) == -1)
            {
               this.var_446.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_443:
               return this.var_446.length;
            case UnseenItemCategoryEnum.const_407:
               return this.var_445.length;
            default:
               return this.var_446.length + this.var_445.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_44:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_407));
                  this.var_445 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_35:
               if(this.var_446 && this.var_446.length > 0)
               {
