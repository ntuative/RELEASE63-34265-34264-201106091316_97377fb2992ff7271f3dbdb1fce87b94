package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1990:int = 0;
      
      private static const const_1019:int = 1;
      
      private static const const_1020:int = 2;
      
      private static const const_1016:int = 3;
      
      private static const const_1017:int = 42;
      
      private static const const_1021:int = 120;
      
      private static const const_1018:int = 4;
      ...
      private var var_794:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_357.add(FurniModelCategory.const_35,new FurniGridView(this.var_76,FurniModelCategory.const_35,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_357.add(FurniModelCategory.const_44,new FurniGridView(this.var_76,FurniModelCategory.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1018;
            _loc3_.y = _loc4_.y + const_1018;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_357.getValue(this.var_427);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_76.getCategoryContent(this.var_427);
         ...
         if(this.var_2248 == _loc2_)
         {
            return;
         }
         this.var_2248 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_35,FurniModelCategory.const_44];
         var _loc4_:int = 0;
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_357.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_357.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_357.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_76.getUnseenItemCount(UnseenItemCategoryEnum.const_407) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_76.getGroupItemInIndex(_loc3_,this.var_427);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_214);
            ...
            {
               if(_loc5_.category == FurniCategory.const_231)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_794 && this.var_794.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1213)
            {
         ...
         else if(param1.type == WindowEvent.const_49)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_264);
            }
         }
      }
