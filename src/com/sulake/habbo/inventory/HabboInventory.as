package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2297:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_72,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_564,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_56.getValue(InventoryCategory.const_78));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_56.getValue(InventorySubCategory.const_349));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_56.getValue(InventoryCategory.const_267));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_56.getValue(InventorySubCategory.const_1230));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_56.getValue(InventoryCategory.const_127));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_56.getValue(InventoryCategory.const_406) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_72,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_564,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_82:
               this.var_1285 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_564:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_414 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_56.add(InventoryCategory.const_406,_loc1_);
         ...
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_414);
         ...
         this.var_56.add(InventorySubCategory.const_349,_loc6_);
         ...
         this.var_56.add(InventorySubCategory.const_1230,_loc7_);
         ...
         this.var_56.add(InventoryCategory.const_127,_loc8_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_1054.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1054.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1054.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2297);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_261));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2823)
         {
            this.var_2823 = _loc1_;
