package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2298:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_414 = param5;
         this.var_414.events.addEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImageReady);
         this._view = new BadgesView(this,param2,param4);
         this.var_702 = [];
         this.var_1338 = new Map();
      }
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1338.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_702.indexOf(param3) != -1;
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_332);
         var _loc3_:int = 0;
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_513);
         ...
         var _loc3_:Array = this.getBadges(const_332);
      ...
      {
         return this.getItemInIndex(param1,const_332);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_513);
      }
      ...
      {
         if(param1 == InventoryCategory.const_267 && this.var_28.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_702.indexOf(_loc2_) == -1)
            {
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_702 && this.var_702.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1343));
            this.var_702 = [];
