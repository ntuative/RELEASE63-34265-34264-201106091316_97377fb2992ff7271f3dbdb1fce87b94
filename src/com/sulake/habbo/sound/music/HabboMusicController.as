package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1515:int = HabboMusicPrioritiesEnum.const_133;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_766,this.onJukeboxInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_284,this.onJukeboxDispose);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_865,this.onSoundMachineInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_737,this.onSoundMachineDispose);
         this.var_1269 = new Timer(1000);
         this.var_1269.start();
         this.var_1269.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_270)
         {
            this.var_322[_loc6_] = null;
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1927)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_280)
            {
               ...
               {
                  _loc3_ = this.var_280.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_766,this.onJukeboxInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_284,this.onJukeboxDispose);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_865,this.onSoundMachineInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_737,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_322[param1];
      ...
      {
         var _loc1_:int = this.var_322.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_322[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_280.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_270)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_653.add(param1,param2);
      ...
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         ...
         {
            return this.var_381.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_381.length)
         {
            return this.var_381.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_322[_loc2_] != null)
            {
               _loc3_ = this.var_322[_loc2_];
               _loc4_ = this.var_280.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_804));
         Logger.log("Requested song info\'s : " + this.var_804);
         this.var_804 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_280.add(_loc6_.id,_loc10_);
               ...
               while(this.var_803.indexOf(_loc6_.id) != -1)
               {
                  this.var_803.splice(this.var_803.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_270)
         {
            return false;
         }
         ...
         this.var_1927 = this.getSongRequestCountAtPriority(param1);
         this.var_1522 = param2;
         if(this._priorityPlaying <= const_1515)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_133)
         {
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_653.getValue(param1);
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_547 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_92,this._connection) as IPlayListController;
      }
