package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1550:int = 60;
      
      private static const const_1548:int = 25165823;
      
      private static const const_1549:int = 16777215;
      ...
      private var var_1046:Number = 1.0;
      ...
      private var var_1587:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_813,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1048.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1333:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1684:
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_202.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_202.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1325.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1047.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_202.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2797 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1047 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_202 == null || this._connection == null || this._roomEngine == null || this.var_243 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1878,this.var_851));
         this.var_851 = -1;
         this.var_850 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_1046 * 100)));
         }
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_243.updateVolume(this.var_1046);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         if(this.var_690.getValue(param1) != null)
         {
            ...
            if(this.var_287.getValue(_loc2_) == null)
            {
               ...
               param1.extract(this.var_1587,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1587,_loc2_,TraxSample.const_1907,TraxSample.const_1863);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1326.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1550 && this.var_1326.length > 0)
            {
               _loc3_ = this.var_1326.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_690.length == 0 && this.var_851 != -1)
            {
               this.var_850.ready = true;
               _loc4_ = this.var_851;
               this.var_851 = -1;
               this.var_850 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_813,_loc4_));
               if(this.var_2797)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_850 == null && this.var_1325.length > 0)
         {
            _loc1_ = this.var_1325.getKey(0);
            _loc2_ = this.var_1325.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_813,_loc1_));
               }
               else
               {
                  this.var_850 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         if(_loc1_ > const_1548)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1549 && _loc9_ < _loc2_.length)
            {
