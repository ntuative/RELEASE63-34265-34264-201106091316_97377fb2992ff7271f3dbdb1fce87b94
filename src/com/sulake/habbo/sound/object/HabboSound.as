package com.sulake.habbo.sound.object
{
   ...
   public class HabboSound implements IHabboSound
   {
      ...
      private var var_1262:Sound = null;
      ...
      public function HabboSound(param1:Sound)
      {
         ...
         this.var_1262.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_1046 = 1;
      ...
      {
         this._complete = false;
         this.var_470 = this.var_1262.play(0);
      ...
      {
         return this.var_1262.length;
      }
      
      public function get ready() : Boolean
      {
         return !this.var_1262.isBuffering;
      }
