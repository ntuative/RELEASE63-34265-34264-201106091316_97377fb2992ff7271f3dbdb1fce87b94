   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_312 != null)
         {
            ...
            {
               _loc2_ = this.var_312.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_731,RoomWidgetChatSelectAvatarMessage.const_864];
      }
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_38) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1247))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_382);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_38) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1247))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_544);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
      ...
      {
         return [RoomSessionChatEvent.const_224];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_224:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_312.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_226)
                                    {
                                       this.var_312.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1199 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1199);
            }
            if(this.var_769 == null)
            {
               ...
               this.var_530.y = 0;
               this.var_530.z = 0;
               this.var_769 = _loc4_.getScreenPoint(this.var_530);
               this.var_1199 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_530.x = 0;
            this.var_530.y = 0;
            this.var_530.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_530);
            if(_loc8_ != null)
            {
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_312)
         {
            _loc2_ = this.var_312.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(this.var_312)
            {
               this.var_312.add(_loc3_,param2);
            }
         }
      }
   }
