package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1470:IMessageEvent;
      
      private var var_1826:IMessageEvent;
      
      private var var_1825:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_164,this.processSoundManagerEvent);
      ...
      {
         this.var_1470 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1826 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1825 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1470);
         this._connection.addMessageEvent(this.var_1826);
         this._connection.addMessageEvent(this.var_1825);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1470);
               this._connection.removeMessageEvent(this.var_1826);
               this._connection.removeMessageEvent(this.var_1825);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_164,this.processSoundManagerEvent);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_734,RoomWidgetPlayListModificationMessage.const_945,RoomWidgetPlayListModificationMessage.const_895,RoomWidgetPlayListPlayStateMessage.const_811,RoomWidgetPlayListUserActionMessage.const_840];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_734:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_966,_loc2_.id);
            ...
            case RoomWidgetPlayListPlayStateMessage.const_811:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_840:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_284:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_989,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_834,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_923));
               break;
            case PlayListStatusEvent.const_103:
               ...
               break;
            case PlayListStatusEvent.const_164:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_164));
               break;
