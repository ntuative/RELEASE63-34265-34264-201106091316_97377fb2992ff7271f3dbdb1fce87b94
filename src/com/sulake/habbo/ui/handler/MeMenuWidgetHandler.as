package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private static const const_464:int = 50;
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_200);
         }
         this.var_1120 = true;
         this.container = null;
         this.var_13 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this.var_13.events.removeEventListener(HabboInventoryEffectsEvent.const_261,this.onAvatarEffectsChanged);
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_829,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_890,this.onHelpTutorialEvent);
         ...
         if(this.var_13 != null)
         {
            this.var_13.events.addEventListener(HabboInventoryEffectsEvent.const_261,this.onAvatarEffectsChanged);
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_829,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_890,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1484)
            {
               ...
               this.var_1842 = _loc1_;
               this.var_1841 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1842;
               _loc2_ = this.var_1841;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_464)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_464,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_464 - const_1056)
                  {
                     _loc8_.offset(0,_loc2_.height - const_464 + const_1056);
                  }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_994);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_831);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1160);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1243);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1256);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_775);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_397);
         _loc1_.push(RoomWidgetStopEffectMessage.const_956);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1916);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1268);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_478);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1671);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1206);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_970);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_914);
         _loc1_.push(RoomWidgetMeMenuMessage.const_785);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_875);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1691);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_971);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_982);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1165);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_914:
            ...
            case RoomWidgetWaveMessage.const_789:
               ...
               break;
            case RoomWidgetDanceMessage.const_994:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_831:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1160:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1243:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_397:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1246)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_775:
               ...
               if(this.var_13 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1796:
                        this._catalog.openCatalogPage(CatalogPageName.const_1342,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1198:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_267);
                        break;
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1256:
            case RoomWidgetStopEffectMessage.const_956:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1268:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_970:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_785:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_478:
               Logger.log("MeMenuWidgetHandler: Open avatar editor...");
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_200,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_200);
                  if(this._container.habboHelp && this._container.habboHelp.events)
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_511));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_875:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_414,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_971:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_414,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_982:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_414,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1165:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_521));
               }
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_128:
               ...
               break;
            case HabboHelpTutorialEvent.const_890:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_489));
         }
      }
