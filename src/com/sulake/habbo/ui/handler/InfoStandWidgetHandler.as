package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_243.events.addEventListener(NowPlayingEvent.const_100,this.onNowPlayingChanged);
            this.var_243.events.addEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_196,this.onUserTags);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_196,this.onUserTags);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_243 != null)
         {
            this.var_243.events.removeEventListener(NowPlayingEvent.const_100,this.onNowPlayingChanged);
            this.var_243.events.removeEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
            this.var_243 = null;
         }
         this.var_1120 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_555);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_929);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_944);
         _loc1_.push(RoomWidgetFurniActionMessage.const_299);
         _loc1_.push(RoomWidgetFurniActionMessage.const_740);
         _loc1_.push(RoomWidgetFurniActionMessage.const_726);
         _loc1_.push(RoomWidgetFurniActionMessage.const_772);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1316);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_742);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_817);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_729);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_519);
         _loc1_.push(RoomWidgetPetCommandMessage.const_959);
         _loc1_.push(RoomWidgetUserActionMessage.const_499);
         _loc1_.push(RoomWidgetUserActionMessage.const_453);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_884);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_453 || param1.type == RoomWidgetUserActionMessage.const_499 || param1.type == RoomWidgetUserActionMessage.const_548)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_555:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_929:
            ...
            case RoomWidgetUserActionMessage.const_630:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1196,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_621:
               ...
               break;
            case RoomWidgetUserActionMessage.const_944:
            ...
            case RoomWidgetUserActionMessage.const_453:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_742:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_817:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_729:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_291);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_362);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_392) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_392);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_818) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1352;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_291);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1319);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1284);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_604)
                  {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_226)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_516)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_147)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_969);
                  ...
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_975;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1694);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_143];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_143:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_969);
