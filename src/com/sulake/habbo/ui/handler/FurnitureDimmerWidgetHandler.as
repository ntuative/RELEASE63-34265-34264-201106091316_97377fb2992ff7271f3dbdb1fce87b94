package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.WIDGET_MESSAGE_REQUEST_DIMMER_WIDGET,RoomWidgetDimmerSavePresetMessage.const_779,RoomWidgetDimmerChangeStateMessage.const_764,RoomWidgetDimmerPreviewMessage.const_759];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.WIDGET_MESSAGE_REQUEST_DIMMER_WIDGET:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_779:
               if(this.validateRights())
               {
            ...
            case RoomWidgetDimmerChangeStateMessage.const_764:
               ...
               break;
            case RoomWidgetDimmerPreviewMessage.const_759:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_637);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_637:
               _loc2_ = param1 as RoomSessionDimmerPresetsEvent;
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_821);
            ...
            case RoomEngineObjectEvent.const_107:
               this._container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_992));
         }
      }
