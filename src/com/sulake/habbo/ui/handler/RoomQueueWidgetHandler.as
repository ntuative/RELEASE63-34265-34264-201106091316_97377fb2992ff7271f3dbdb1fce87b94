package com.sulake.habbo.ui.handler
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_819:
            ...
            case RoomWidgetRoomQueueMessage.const_815:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1181);
               break;
            case RoomWidgetRoomQueueMessage.const_973:
      ...
      {
         return [RoomSessionQueueEvent.const_631];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_631:
               ...
               {
                  case RoomSessionQueueEvent.const_1181:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc5_.length > 1)
               {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1950) + 1;
                  }
               }
               else
               {
