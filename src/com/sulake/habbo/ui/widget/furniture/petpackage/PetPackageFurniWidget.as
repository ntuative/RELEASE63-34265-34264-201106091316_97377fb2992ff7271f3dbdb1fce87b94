package com.sulake.habbo.ui.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_416,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_416,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomWidgetPetPackageUpdateEvent.const_561:
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_416:
               if(event.objectId != this.var_232)
               {
                  return;
               }
               this.var_614 = event.image;
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1170 || this.var_232 == -1)
         {
            return;
         }
         ...
         {
            this.var_1170 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_916,this.var_232,name);
