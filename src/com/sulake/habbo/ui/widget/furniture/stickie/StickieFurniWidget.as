package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1415:int = 14;
      
      private static const const_1414:int = 500;
      
      private static const const_1456:Number = 100;
      
      private static const const_1455:Number = 100;
       
      
      private var _window:IWindowContainer;
      
      protected var var_232:int = -1;
      
      protected var var_1385:String;
      
      protected var _text:String;
      
      protected var var_348:String;
      
      protected var var_28:Boolean;
      
      protected var var_2202:String = "stickieui_container";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_974,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_974,this.onObjectUpdate);
      }
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1385 = param1.objectType;
         this._text = param1.text;
         this.var_348 = param1.colorHex;
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2202,"",HabboWindowType.const_75,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1456,const_1455,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null)
         {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_348);
            }
         ...
         this.setColorButtons(this.var_28 && this.var_1385 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_503,this.var_232,this._text,this.var_348);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_503,this.var_232,this._text,this.var_348);
      ...
      protected function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_812,this.var_232);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1414;
         if(_loc2_.numLines < const_1415)
         {
            return;
         }
