package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_644:DimmerViewColorGrid;
      
      private var var_449:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_75,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1456,const_1455,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_644 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_449 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_449 != null)
         {
            this.var_449.setValue(this.var_1505);
         }
         this.var_525 = this.colors.indexOf(_loc2_.color);
         if(this.var_644 != null)
         {
            this.var_644.setSelectedColorIndex(this.var_525);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1506 = XML(_loc1_.content);
         return this.var_1506;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_449 != null)
         {
            this.var_449.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_644 != null)
         {
            this.var_644.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
