package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2000:int = 0;
      
      private const const_2001:int = 1;
      
      private const const_1999:int = 2;
      
      private const const_1998:int = 3;
      
      private const const_1996:int = 4;
      
      private const const_2265:int = 0;
      
      private const const_2269:int = 1;
      
      private const const_2268:int = 2;
      
      private const const_2263:int = 3;
      
      private const const_2264:int = 4;
      
      private const const_2266:int = 5;
      
      private const const_1995:String = "deco_img";
      
      private const const_1997:String = "dialog_bg";
      
      private const const_2267:String = "%campaign%_dialog_bg.png";
      
      private const const_379:String = "%campaign%_gift_package.png";
      
      private const const_2271:String = "%campaign%_gift_content.png";
      
      private const const_2270:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1466 = this.var_154.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1466 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1468.length)
         {
            _loc2_ = this.var_1468.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_154 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_925,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_977,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_598:
               _loc2_ = this.const_2000;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_977:
               ...
               this._shareId = null;
               this.var_1469 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_925:
               _loc2_ = this.const_2001;
               this.var_232 = param1.objectId;
               this._shareId = param1.data;
               this.var_425 = param1.status;
               this.var_1469 = param1.itemCategory;
               var_69.registerParameter("notifications.viral_furni.fb.title","realname",param1.method_1);
               var_69.registerParameter("notifications.viral_furni.fb.desc","realname",param1.method_1);
         ...
         if(this._window && (this.var_1467 != _loc2_ || _loc3_ != this.var_190))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_190 = _loc3_;
         this.var_1467 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1467)
            {
               ...
               case this.const_2001:
                  ...
                  else if(this.var_425 == this.const_2269)
                  {
                     ...
                     _loc2_ = this.const_2271;
                  }
                  else if(this.var_425 == this.const_2268)
                  {
                  ...
                  else if(this.var_425 == this.const_2263)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_425 == this.const_2264)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_190,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_425 == this.const_2266)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2267.replace("%campaign%",this.var_190);
            this.setDecoImage(_loc5_,this.const_1997);
            _loc2_ = _loc2_.replace("%campaign%",this.var_190);
            this.setDecoImage(_loc2_,this.const_1995);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_965);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1469 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1469 == 1 ? "null" : InventoryCategory.const_127);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_939,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1468.push(new ImageDownloader(this,_assets,this.var_190,this.var_1466,param1,param2));
            return;
         }
