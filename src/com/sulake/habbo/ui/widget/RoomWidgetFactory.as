package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3020:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3020 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_389:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_69,this.var_154,this.var_2580++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_440:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_69,this.var_154,this);
               break;
            case RoomWidgetEnum.const_657:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_69,this.var_154,this._catalog);
               break;
            case RoomWidgetEnum.const_517:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_69,events,this.var_154);
               break;
            ...
            case RoomWidgetEnum.const_592:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_69,this.var_154,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_568:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_69,this.var_154);
               break;
            case RoomWidgetEnum.const_934:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_69,this.var_154);
               break;
            case RoomWidgetEnum.const_138:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_69,this.var_154);
               break;
            ...
            case RoomWidgetEnum.const_125:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_154,this.var_69,this);
               break;
            ...
            case RoomWidgetEnum.const_545:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_69,this.var_154,this._catalog);
               break;
