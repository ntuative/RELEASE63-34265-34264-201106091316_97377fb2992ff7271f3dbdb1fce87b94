package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1031:String = "use_minimized_own_avatar_menu";
      ...
      private var var_756:OwnAvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_2341 = Boolean(this.var_202.getBoolean("menu.avatar.enabled",false));
         this.var_1759 = this.var_202.getBoolean("menu.own_avatar.enabled",false);
         ...
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_448,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_261,this.onEffectsChanged);
         this.handler.widget = this;
      }
      
      public function get handler() : AvatarInfoWidgetHandler
      {
         return var_1118 as AvatarInfoWidgetHandler;
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_908,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_448,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_261,this.onEffectsChanged);
         this._view = null;
         this.var_202 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_362,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_653,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_778,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_428,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_362,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_653,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_428,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_428,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_125:
               ...
               if(this.var_1759 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_653:
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_362:
               if(this._view)
               {
                  this.removeView(this._view,false);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_778:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1758 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_929,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_428:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1758)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_147:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_129,false,!!_loc3_.isSpectatorMode ? null : this.var_236);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_516,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.const_111:
               _loc5_ = param1 as RoomWidgetPetInfoUpdateEvent;
               this.updateView(_loc5_.id,_loc5_.name,_loc5_.roomIndex,RoomObjectTypeEnum.const_226,false,null);
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_176:
               ...
               for each(_loc7_ in this.var_364)
               {
      ...
      private function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_318,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      private function storeUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.var_236.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_108;
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1759) : Boolean(this.var_2341);
         }
            ...
            if(!this.var_1760)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_756)
                     {
                        this.var_756 = new OwnAvatarMenuView(this);
                     }
                  ...
                  else
                  {
                     ...
                     for each(_loc8_ in this.var_364)
                     {
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_364.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_364.length > 0)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc3_ in this.var_364)
         {
      ...
      {
         this.handler.container.avatarEditor.openEditor(AvatarEditorInstanceId.const_200,null,null,true);
         this.handler.container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_200);
      }
      ...
      {
         return this.handler.container.config.getBoolean(const_1031,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1031,!!param1 ? "1" : "0");
      }
   }
}
