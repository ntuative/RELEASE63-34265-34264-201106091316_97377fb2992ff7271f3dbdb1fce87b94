package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1008:uint = 2;
      
      protected static var var_1408:uint = const_374;
      
      private static const const_1503:uint = 16744755;
      
      private static const const_1504:uint = 16756591;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1394)
         {
            ...
            {
               this.var_350 = const_1008;
            }
            else
            {
               this.var_350 = var_1408;
            }
         }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1503;
               }
            }
         }
         if(_loc3_)
