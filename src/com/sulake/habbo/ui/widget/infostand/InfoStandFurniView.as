package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_259 = this.var_48.findChildByTag("catalog");
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1352 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_604 && param1.isRoomOwner)
         {
