package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1445:int = 152;
      
      private static const const_1443:int = 16;
      
      private static const const_673:int = 4;
      
      private static const const_1446:uint = 14342874;
      
      private static const const_1449:uint = 3815994;
      
      private static const const_1448:uint = 2085362;
      
      private static const const_1452:uint = 39616;
      
      private static const const_1447:uint = 10513106;
      
      private static const const_1440:uint = 8734654;
      
      private static const const_1451:uint = 9094430;
      
      private static const const_1450:uint = 6200576;
      
      private static const const_1442:String = "happiness";
      
      private static const const_1441:String = "experience";
      
      private static const const_1439:String = "energy";
      
      private static const const_1444:int = 250;
      ...
      {
         if(this.var_54 == null || this.var_48 == null || this.var_107 == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1442,param1.nutrition,param1.nutritionMax,const_1452,const_1448);
         this.updateStateElement(const_1441,param1.experience,param1.experienceMax,const_1440,const_1447);
         this.updateStateElement(const_1439,param1.energy,param1.energyMax,const_1450,const_1451);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1445,const_1443,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1446);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1449);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_673,_loc7_.width - 2,_loc7_.height - 2 - const_673);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_673);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_548) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_212 && this.var_212.getPetId() == this.var_548)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1719,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_454,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1042 + const_1043;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1043;
            }
         }
         this.var_107.height = _loc4_ + const_1042;
         this.updateWindow();
      }
   }
}
