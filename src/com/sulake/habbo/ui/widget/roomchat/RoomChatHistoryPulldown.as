package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_1059:int = 3;
      
      public static const const_576:int = 2;
      
      public static const const_426:int = 1;
      
      public static const const_297:int = 0;
      
      public static const const_89:int = 39;
      
      private static const const_1093:int = 150;
      ...
      private var var_2855:BitmapData;
      ...
      private var var_2856:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_44 = param3;
         this.var_2853 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_2051 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2855 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_2049 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_2050 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2851 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2856 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_82 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_361,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,param3.width,param3.height - const_89),null,0,0) as IBitmapWrapperWindow;
         this.var_44.addChild(this.var_82);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_75,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_44.height - const_89,param3.width,const_89),null,0) as IWindowContainer;
         this.var_44.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_447,HabboWindowStyle.const_47,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_89),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_576:
               this.var_82.blend += param1 / const_1094;
               this._window.blend += param1 / const_1094;
               if(this._window.blend >= 1)
               {
                  this.state = const_426;
               }
               break;
            case const_1059:
               this.var_82.blend -= param1 / const_1093;
               this._window.blend -= param1 / const_1093;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_426:
               if(this._state == const_297)
               {
                  this.state = const_576;
               }
               else
               {
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_44.height - const_89;
            this._window.width = this.var_44.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_44.height - const_89;
            this._region.width = this.var_44.width - this.var_2854;
         }
         if(this.var_82 != null)
         {
            this.var_82.rectangle = this.var_44.rectangle;
            this.var_82.height -= const_89;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2852 == this._window.width)
         {
            return;
         }
         this.var_2852 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2855;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_2049;
            barX.disposesBitmap = false;
            this.var_2854 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2853,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2051,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2051,destGripRBitmap);
         ...
         this.var_82.bitmap = this.var_2856;
