package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectsWidget extends RoomWidgetBase
   {
      ...
      private static const const_1418:int = 320;
      
      private static const const_1416:int = 48;
      ...
      {
         return var_1118 as EffectsWidgetHandler;
      }
      ...
      public function open() : void
      {
         ...
         if(!this._view)
         {
            ...
            this._view.x = _loc2_.right + const_1417;
      ...
      public function update() : void
      {
         ...
         {
            _loc1_ = this.var_612.getValue(_loc3_.type) as EffectView;
            if(_loc1_)
            {
               _loc1_.update();
            }
            else
            {
               ...
               this.var_612.add(_loc3_.type,_loc1_);
         ...
         _loc4_ = this.var_65.scrollableRegion.height;
         this.var_65.height = Math.max(Math.min(_loc4_,const_1418),const_1416);
      ...
      {
         this.handler.container.catalog.openCatalogPage(CatalogPageName.const_1342,true);
      }
   }
}
