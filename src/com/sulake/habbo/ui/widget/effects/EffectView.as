package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2296:int = 1000;
      ...
      private var var_572:ITextWindow;
      
      private var var_214:Timer;
      
      private var var_692:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_129 = param2;
         this._widget = param1;
         this.var_214 = new Timer(this.const_2296);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_129.isActive)
         {
            ...
            this.var_693.width = _loc2_ * this.var_344;
         }
         else
         {
            this.var_693.width = 0;
            this.var_214.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_572 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_572 == null)
            {
               return;
            }
         ...
         if(!this.var_129.isActive)
         {
            this.var_572.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_572.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_572.text;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_75,HabboWindowStyle.const_30,HabboWindowParam.const_65) as IWindowContainer;
         }
         ...
         else
         {
            ...
            this.var_692 = this._window.findChildByName("effect_hilite");
            this.var_692.visible = false;
         }
         this.setTimeLeft();
         this.var_693 = this._window.findChildByName("loader_bar");
         if(this.var_693 != null)
         {
            this.var_344 = this.var_693.width;
            this.var_214.start();
            this.onUpdate();
         }
