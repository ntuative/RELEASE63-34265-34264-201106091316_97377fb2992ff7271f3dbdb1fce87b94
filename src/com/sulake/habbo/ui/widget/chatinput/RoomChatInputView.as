package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1535:String = "${widgets.chatinput.say}";
      ...
      private var var_29:ITextFieldWindow;
      
      private var var_1999:IWindow;
      
      private var _button:IWindow;
      
      private var var_2000:IWindow;
      
      private var var_1568:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1304 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2761 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2760 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this.var_29 = this._window.findChildByName("chat_input") as ITextFieldWindow;
         this.var_1999 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2000 = this._window.findChildByName("send_button_text");
         this.var_1568 = this._window.findChildByName("block_text");
         this.var_2000.caption = const_1535;
         this.var_29.setParamFlag(HabboWindowParam.const_45,true);
         this.var_29.addEventListener(WindowMouseEvent.const_43,this.windowMouseEventProcessor);
         this.var_29.addEventListener(WindowKeyboardEvent.const_229,this.windowKeyEventProcessor);
         this.var_29.addEventListener(WindowKeyboardEvent.const_339,this.keyUpHandler);
         this.var_29.addEventListener(WindowEvent.const_110,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1569 = true;
         this.var_676 = "";
         this._window.addEventListener(WindowEvent.const_917,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_487,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1999.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1534 - _loc3_;
      ...
      {
         if(this._window == null || this.var_29 == null)
         {
            return;
         }
         this.var_29.enable();
         this.var_29.selectable = true;
         this.var_29.text = "";
         this.setInputFieldFocus();
         this.var_29.text += param1 + " ";
         if(param2.length > 0)
         {
            this.var_29.text += param2 + " ";
         }
         this.var_29.setSelection(this.var_29.text.length,this.var_29.text.length);
         this.var_676 = this.var_29.text;
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_29 != null)
            {
               _loc7_ = this.var_29.text;
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1304 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_29.text = "";
                  this.var_676 = "";
               }
      ...
      {
         if(this.var_29 == null || this.var_29.text == "")
         {
            return;
         }
         var _loc1_:String = this.var_29.text;
         var _loc2_:String = this._widget.selectedUserName;
         if(_loc1_ == this.var_1304)
         {
            if(_loc2_.length > 0)
            {
               this.var_29.text += " " + this._widget.selectedUserName;
               this.var_29.setSelection(this.var_29.text.length,this.var_29.text.length);
               this.var_676 = this.var_29.text;
            }
         }
      ...
      private function setInputFieldFocus() : void
      {
         ...
         {
            this.var_29.text = "";
            this.var_29.textColor = 0;
            this.var_29.italic = false;
            this.var_1569 = false;
            this.var_676 = "";
         }
         this.var_29.focus();
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc3_:String = this.var_29.text;
