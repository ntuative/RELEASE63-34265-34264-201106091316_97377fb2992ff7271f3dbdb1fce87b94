package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private static const const_1525:int = 5000;
      ...
      private var var_325:Timer = null;
      ...
      {
         return getTimer() - this.var_2729 > const_1525;
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_805,this.onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_147,this.onUserInfo);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_958,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_805,this.onChatInputUpdate);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_147,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_958,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1196:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1720:
         }
      }
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this._visualization.updateBlockText(this.var_325.repeatCount - this.var_325.currentCount);
         }
      }
      ...
      public function onFloodControl(param1:RoomWidgetFloodControlEvent) : void
      {
         ...
         {
            this.var_325 = new Timer(1000,param1.seconds);
            this.var_325.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_325.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_325.start();
         if(this._visualization != null)
         {
