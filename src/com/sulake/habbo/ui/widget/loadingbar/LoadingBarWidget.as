package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_578:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_578.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_578 = null;
         }
         if(this.var_47 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_578 == null)
         {
            this.var_578 = new Sprite();
            this.var_578.addChild(new Bitmap(this.var_47));
            this.var_578.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_578.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_47;
            }
         }
         _loc2_.setDisplayObject(this.var_578);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1303 != "")
         {
            HabboWebTools.openWebPage(this.var_1303);
         }
      }
   }
}
