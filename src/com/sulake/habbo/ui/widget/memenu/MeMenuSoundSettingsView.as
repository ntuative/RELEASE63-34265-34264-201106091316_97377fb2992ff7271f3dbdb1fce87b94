package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_1046 = param1.volume;
         if(this.var_1088 != null)
         {
            this.var_1088.setValue(this.var_1046);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1089 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_875));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1046 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1092);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1090);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1091);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1089);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_982);
         }
