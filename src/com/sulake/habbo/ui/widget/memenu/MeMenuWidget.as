package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_180:String = "me_menu_top_view";
      
      public static const const_656:String = "me_menu_my_clothes_view";
      
      public static const const_1263:String = "me_menu_dance_moves_view";
      
      public static const const_1001:String = "me_menu_settings_view";
      
      public static const const_851:String = "me_menu_sound_settings";
      
      private static const const_1098:Point = new Point(95,440);
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2861 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_1759 = this._config.getBoolean("menu.own_avatar.enabled",false);
         (param1 as MeMenuWidgetHandler).widget = this;
         this.changeView(const_180);
         this.hide();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_993,this.onWaveEvent);
         ...
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1285,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1267,this.onHideAvatarEditor);
         ...
         param1.addEventListener(RoomWidgetTutorialEvent.const_489,this.onTutorialEvent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_993,this.onWaveEvent);
         ...
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1285,this.onHideAvatarEditor);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1267,this.onAvatarEditorClosed);
         ...
         param1.removeEventListener(RoomWidgetTutorialEvent.const_489,this.onTutorialEvent);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_577 && this.var_53.window.name == const_656))
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_914);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_53.window.name == const_851)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_489:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_577 + " view: " + this.var_53.window.name);
               if(this.var_577 != true || this.var_53.window.name != const_180)
               {
                  return;
               }
               (this.var_53 as MeMenuMainView).setIconAssets("clothes_icon",const_180,"clothes_highlighter_blue");
               break;
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_577)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_785);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      {
         if(this.var_53 != null && this.var_53.window.name != const_656)
         {
            this.hide();
         }
      }
      ...
      {
         var _loc2_:* = param1.daysLeft != this.var_1609;
         this.var_1609 = param1.daysLeft;
         this.var_2863 = param1.periodsLeft;
         this.var_3030 = param1.pastPeriods;
         this.var_2862 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_2054);
         this.var_2054 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_53 != null)
            {
