package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorItemListView
   {
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(this.var_1377 >= 0 && this.var_1377 < this._items.length)
         {
            _loc2_ = this._items[this.var_1377] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_565);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1202);
