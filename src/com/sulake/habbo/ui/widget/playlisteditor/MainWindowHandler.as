package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private static const const_1662:int = 6;
      
      private static const const_1660:int = 9;
      ...
      private var var_1105:IBorderWindow;
      
      private var var_1106:IBorderWindow;
      
      private var var_586:MusicInventoryGridView;
      
      private var var_892:PlayListEditorItemListView;
      
      private var var_255:MusicInventoryStatusView;
      
      private var var_336:PlayListStatusView;
      
      private var var_2137:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_243 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_792,PlayListEditorWidgetAssetsEnum.const_915,PlayListEditorWidgetAssetsEnum.const_610,PlayListEditorWidgetAssetsEnum.const_504,PlayListEditorWidgetAssetsEnum.const_796];
         ...
         this.var_892 = new PlayListEditorItemListView(param1,this.getPlayListEditorItemList());
         this.var_255 = new MusicInventoryStatusView(param1,this.getMusicInventoryStatusContainer());
         this.var_336 = new PlayListStatusView(param1,this.getPlayListStatusContainer());
      ...
      public function destroy() : void
      {
         if(this.var_243)
         {
            this.var_243.stop(HabboMusicPrioritiesEnum.const_400);
            this.var_243 = null;
         }
         if(this.var_586)
         {
         ...
         if(this.var_892)
         {
            this.var_892.destroy();
            this.var_892 = null;
         }
         if(this.var_336)
         {
            this.var_336.destroy();
            this.var_336 = null;
         }
         if(this.var_255)
         {
      ...
      {
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_792)
         {
            this.assignWindowBitmapByAsset(this.var_1105,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_792);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_915)
         {
            this.assignWindowBitmapByAsset(this.var_1106,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_915);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_610)
         {
            this.var_255.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_610));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_504)
         {
            this.var_255.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_504));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_796)
         {
            this.var_336.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_796);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1105 = _loc2_.getChildByName("my_music_border") as IBorderWindow;
         this.var_1106 = _loc2_.getChildByName("playlist_border") as IBorderWindow;
         ...
         this.var_2137 = this.var_1105.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_2136 = this.var_1106.getChildByName("playlist_scrollbar") as IScrollbarWindow;
      ...
      {
         return this.var_1105.getChildByName("music_inventory_itemgrid") as IItemGridWindow;
      }
      
      private function getPlayListEditorItemList() : IItemListWindow
      {
         return this.var_1106.getChildByName("playlist_editor_itemlist") as IItemListWindow;
      }
      
      private function getMusicInventoryStatusContainer() : IWindowContainer
      {
         return this.var_1105.getChildByName("preview_play_container") as IWindowContainer;
      }
      
      private function getPlayListStatusContainer() : IWindowContainer
      {
         return this.var_1106.getChildByName("now_playing_container") as IWindowContainer;
      }
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_336.selectView(PlayListStatusView.const_477);
         }
         else if(_loc1_.length > 0)
         {
            this.var_336.selectView(PlayListStatusView.const_1201);
         }
         else
         {
            this.var_336.selectView(PlayListStatusView.const_725);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_255.show();
            this.var_255.selectView(MusicInventoryStatusView.const_972);
         }
         else if(this.var_243.getSongDiskInventorySize() <= const_1662)
         {
            this.var_255.show();
            this.var_255.selectView(MusicInventoryStatusView.const_750);
         }
         else
         {
            this.var_255.hide();
      ...
      private function updatePlaylistEditorView() : void
      {
         ...
         this.var_892.refresh(_loc2_,_loc3_);
      }
      ...
      public function onPlayListUpdated() : void
      {
         ...
         if(_loc2_ != -1)
         {
            ...
            this.var_336.nowPlayingTrackName = _loc3_.name;
            this.var_336.nowPlayingAuthorName = _loc3_.creator;
         }
         this.var_2136.visible = _loc1_.length > const_1661;
      }
      ...
      public function onSongDiskInventoryReceived() : void
      {
         ...
         this.var_2137.visible = this.var_586.itemCount > const_1660;
      }
      ...
      public function onNowPlayingChanged(param1:RoomWidgetPlayListEditorNowPlayingEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_100:
               this.selectPlayListStatusViewByFurniPlayListState();
               this.var_892.setItemIndexPlaying(param1.position);
               if(param1.id != -1)
               {
                  _loc3_ = this.var_243.getSongInfo(param1.id);
                  this.var_336.nowPlayingTrackName = _loc3_ != null ? _loc3_.name : "";
                  this.var_336.nowPlayingAuthorName = _loc3_ != null ? _loc3_.creator : "";
               }
               break;
      ...
      {
         return this.var_243.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_400) != -1;
      }
   }
}
