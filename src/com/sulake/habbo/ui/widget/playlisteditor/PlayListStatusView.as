package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_725:String = "PLSV_ADD_SONGS";
      
      public static const const_1201:String = "PLSV_START_PLAYBACK";
      
      public static const const_477:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_477)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_464[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_464[const_725];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_464.add(const_477,_loc1_);
