   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_689.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_111.playButtonState = MusicInventoryGridItem.const_1239;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_111 != null)
         {
            this.var_111.playButtonState = MusicInventoryGridItem.const_572;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_111.playButtonState == MusicInventoryGridItem.const_572)
               {
                  this.var_111.playButtonState = MusicInventoryGridItem.const_1143;
            ...
            {
               _loc4_ = this.var_689.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
