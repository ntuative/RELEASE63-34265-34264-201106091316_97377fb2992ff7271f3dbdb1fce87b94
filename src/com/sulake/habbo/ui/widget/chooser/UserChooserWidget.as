package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class UserChooserWidget extends ChooserWidgetBase
   {
      ...
      private const const_2276:int = 0;
      
      private const const_2006:int = 1;
      
      private var var_448:ChooserView;
      ...
      {
         if(this.var_448 != null && this.var_448.isOpen())
         {
            return this.const_2006;
         }
         return this.const_2276;
      }
      ...
      override public function initialize(param1:int = 0) : void
      {
         ...
         if(param1 == this.const_2006)
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_382);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_855,this.onUpdateUserChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_855,this.onUpdateUserChooser);
      }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(this.var_448 == null)
         {
            this.var_448 = new ChooserView(this,"${widget.chooser.user.title}");
         }
         this.var_448.populate(param1.items,false);
      }
      ...
      private function onUpdateUserChooser(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         var _loc2_:RoomWidgetRequestWidgetMessage = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_382);
         messageListener.processWidgetMessage(_loc2_);
      }
   }
}
