package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1579:int = 30000;
      ...
      public function VoteWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1579 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_183.reset();
            this.var_183.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_183 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_151,this.showVoteQuestion);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_151,this.showVoteQuestion);
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         {
            this.var_183 = new Timer(1000);
            this.var_183.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc4_ = Number(_loc1_) / this.var_1579;
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1579 - _loc1_) / 1000,0);
