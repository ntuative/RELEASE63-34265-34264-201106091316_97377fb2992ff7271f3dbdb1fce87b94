package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_2088:int = 200;
      ...
      {
         this.var_875 = IWindowContainer(this.var_37.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1968;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_875.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1082.length < var_2088)
         {
            ...
            param1.width = this.var_875.width;
            param1.height = this.var_875.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1628)
         {
