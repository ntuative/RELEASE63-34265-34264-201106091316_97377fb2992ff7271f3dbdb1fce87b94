package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_825:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2722 = param2.pickerUserId;
         this.var_2723 = param2.pickerUserName;
         this.var_1533 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1294 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1293;
         }
         if(this.var_826 == null || param1.timeStamp < this.var_826.timeStamp)
         {
            this.var_826 = param1;
         }
         if(this.var_825 == null || param1.priority > this.var_825.timeStamp)
         {
            this.var_825 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_825;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_826;
         if(_loc2_ == null)
         {
