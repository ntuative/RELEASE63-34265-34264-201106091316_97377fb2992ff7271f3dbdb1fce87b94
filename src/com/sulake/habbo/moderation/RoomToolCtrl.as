package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1133:IDropMenuWindow;
      
      private var var_554:ITextFieldWindow;
      
      private var var_721:Boolean = true;
      
      private var var_1081:ICheckBoxWindow;
      
      private var var_1624:ICheckBoxWindow;
      
      private var var_1625:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_37.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_363));
         Logger.log("BEGINNING TO SHOW: " + this.var_363);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1679;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_554 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_554.procedure = this.onInputClick;
         this.var_1133 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1133);
         this.var_1133.procedure = this.onSelectTemplate;
         this.var_1081 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1624 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1625 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_37,WindowTracker.const_935,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_721 || this.var_554.text == "")
         {
            this.var_37.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1081.isSelected);
         this.var_37.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1807,_loc2_,this.var_554.text,"",""));
         if(this.var_1624.isSelected || this.var_1625.isSelected || this.var_1081.isSelected)
         {
            this.var_37.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1624.isSelected,this.var_1625.isSelected,this.var_1081.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1930);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1758);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_37.initMsg.roomMessageTemplates[this.var_1133.selection];
         if(_loc3_ != null)
         {
            this.var_721 = false;
            this.var_554.text = _loc3_;
         }
      }
   }
}
