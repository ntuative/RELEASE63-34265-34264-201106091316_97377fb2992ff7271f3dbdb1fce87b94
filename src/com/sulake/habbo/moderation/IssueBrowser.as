package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2278:String = "my_issues";
      
      private const const_2279:String = "open_issues";
      
      private const const_2280:String = "picked_issues";
      
      private const const_2301:String = "closed_issues";
      ...
      private var var_375:IIssueBrowserView;
      
      private var var_1898:IIssueBrowserView;
      
      private var var_1897:IIssueBrowserView;
      
      private var var_1899:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_375.view.width = this.var_277.container.width;
         this.var_375.view.height = this.var_277.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2278:
               if(this.var_1898 == null)
               {
                  this.var_1898 = new MyIssuesView(this.issueManager,this,this.var_277.container);
               }
               return this.var_1898;
            case this.const_2279:
               if(this.var_1897 == null)
               {
                  this.var_1897 = new OpenIssuesView(this.issueManager,this,this.var_277.container);
               }
               return this.var_1897;
            case this.const_2280:
               if(this.var_1899 == null)
               {
                  this.var_1899 = new PickedIssuesView(this.issueManager,this,this.var_277.container);
               }
