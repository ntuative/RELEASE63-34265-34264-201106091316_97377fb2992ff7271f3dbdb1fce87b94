package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1071:int = 3600;
      
      private static const const_1069:int = 86400;
      
      private static const const_1072:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_1071) + " hours ago";
         }
         if(param1 < 2 * const_1072)
         {
            return Math.round(param1 / const_1069) + " days ago";
         }
         return Math.round(param1 / const_1072) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1266.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_37.getXmlWindow("user_info"));
            this.var_1266.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_37,WindowTracker.const_1295,this._data.userId),this._callerFrame,this.var_1267,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new RoomVisitsCtrl(this.var_37,this._data.userId),this._callerFrame,this.var_1267,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new SendMsgsCtrl(this.var_37,this._data.userId,this._data.userName,this.var_1552),this._callerFrame,this.var_1267,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ModActionCtrl(this.var_37,this._data.userId,this._data.userName,this.var_1552),this._callerFrame,this.var_1267,false,true);
      }
