package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1362:String = "issue_bundle_open";
      
      public static const const_732:String = "issue_bundle_my";
      
      public static const const_1245:String = "issue_bundle_picked";
      
      public static const const_1923:int = 15000;
       
      
      private var var_72:ModerationManager;
      
      private var var_683:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_683 = new IssueBrowser(this,this.var_72.windowManager,this.var_72.assets);
         this.var_1316 = [];
         this.var_1317 = [];
         this.var_1036 = new Map();
         this.var_2772 = parseInt(this.var_72.configuration.getKey("chf.score.updatefactor","60"));
         this.var_2012 = new Timer(const_1923,0);
         this.var_2012.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_2012.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1316 = this.var_1316.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_177 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1317 = this.var_1317.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_683 == null || !this.var_683.isOpen())
         {
            this.var_72.soundManager.playSound(HabboSoundTypesEnum.const_1333);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_1037.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_1037.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1739)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_117)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_1037.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2773++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_1037.add(param1.issueId,_loc2_);
         ...
         if(this.var_1316.indexOf(param1.issueId) != -1)
         {
         ...
         if(param1.state == IssueMessageData.const_177)
         {
            ...
            _loc9_ = this.var_1317.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2772);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_1036.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_1036.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_1037.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_117.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_117)
         {
            ...
            {
               case const_1362:
                  if(_loc4_.state == IssueMessageData.const_177)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_1036.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_1036.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_1036.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
