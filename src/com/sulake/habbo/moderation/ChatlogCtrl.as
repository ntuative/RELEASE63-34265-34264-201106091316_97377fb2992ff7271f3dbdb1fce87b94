package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1085:Array = [];
      
      private static var var_2100:int = 1000;
      
      private static var var_1084:Array = [];
      
      private static var var_2101:int = 200;
      ...
      private var var_2102:IMessageComposer;
      ...
      {
         this.var_883 = IWindowContainer(this.var_37.getXmlWindow("chatlog_roomheader"));
         this.var_882 = IWindowContainer(this.var_37.getXmlWindow("chatlog_chatline"));
         this.var_557 = new Timer(1000,1);
         ...
         this.var_37.connection.send(this.var_2102);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1085.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_882.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1085.length < var_2100)
         {
            ...
            param1.width = this.var_882.width;
            param1.height = this.var_882.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1084.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2103[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
