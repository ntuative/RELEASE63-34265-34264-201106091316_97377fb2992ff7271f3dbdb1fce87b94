package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1290:IDropMenuWindow;
      ...
      private var var_1021:OffenceCategoryData;
      
      private var var_1022:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1291 = IButtonWindow(this.var_37.getXmlWindow("modact_offence"));
         this.var_1289 = IButtonWindow(this.var_37.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this.var_1290 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1290);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1021 != null;
         if(this.var_1022 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1022.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1021 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1021.offences,this.var_1291,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_37.initMsg.offenceCategories,this.var_1289,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.connection.send(new ModAlertMessageComposer(this.var_1551,this.var_554.text,this.var_1552));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1021 = this.var_37.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1022 = this.var_1021.offences[_loc3_];
         this.var_554.text = this.var_1022.msg;
         this.var_721 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.connection.send(new ModKickMessageComposer(this.var_1551,this.var_554.text,this.var_1552));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1290.selection < 0)
         {
            this.var_37.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_37.connection.send(new ModBanMessageComposer(this.var_1551,this.var_554.text,this.getBanLength(),this.var_1552));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1290.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1291.destroy();
            this.var_1291 = null;
         }
         if(this.var_1289 != null)
         {
            this.var_1289.destroy();
            this.var_1289 = null;
         }
         this.var_1290 = null;
         this.var_554 = null;
