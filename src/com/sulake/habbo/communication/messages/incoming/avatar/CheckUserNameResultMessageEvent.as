package com.sulake.habbo.communication.messages.incoming.avatar
{
   ...
   public class CheckUserNameResultMessageEvent extends MessageEvent implements IMessageEvent
   {
      ...
      public static var var_589:int = 0;
      
      public static var var_904:int = 1;
      
      public static var var_903:int = 2;
      
      public static var var_901:int = 3;
      
      public static var var_902:int = 4;
      
      public static var var_905:int = 5;
