package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_576:IKeyExchange;
      
      private var var_1071:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2857:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_705 = param1;
            this.var_61.initConnection(HabboConnectionType.const_247);
         }
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_705 = this.var_154.getKey("sso.ticket",null);
         this.var_2053 = this.var_154.getKey("flash.client.url","");
         this.var_2859 = this.var_154.getKey("external.variables.txt","");
         if(this.var_252 == null)
         {
            this.var_252 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_591,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1821);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_61.mode = HabboConnectionType.const_1356;
            }
         }
         this.var_61.initConnection(HabboConnectionType.const_247);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_924);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2857 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_61.mode)
         {
            case HabboConnectionType.const_95:
               ...
               this.var_252.loadBannerImage(_loc7_ + "?token=" + this.var_1607,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1356:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1806:
               this.var_1071 = this.generateRandomHexString(30);
               this.var_576 = new DiffieHellman(new BigInteger(this.var_154.getKey("connection.development.prime"),16),new BigInteger(this.var_154.getKey("connection.development.generator"),16));
               this.var_576.init(this.var_1071);
               _loc8_ = this.var_576.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_576.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_576.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2857);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_2053,this.var_2859));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2007,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_705 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_705);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2858)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1607);
         ...
         this.var_576 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_576.init(_loc14_);
            _loc15_ = this.var_576.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1071 = _loc14_;
            }
