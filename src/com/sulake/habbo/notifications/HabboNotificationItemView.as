package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_652:int = 70;
      
      public static const const_1715:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_576:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         this.var_1847 = this._window.height;
         this.var_1488 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_576:
               ...
               _loc2_ = Number(this.var_1231) / Number(this.var_977["time_fade_in"]);
               if(this.var_1231 > int(this.var_977["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1060:
               ...
               if(this.var_1487 > int(this.var_977["time_display"]) && !this.var_1848)
               {
                  this.startFadeOut();
               }
               break;
            case const_1059:
               ...
               _loc3_ = 1 - Number(this.var_1232) / Number(this.var_977["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1232 > int(this.var_977["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         if(this._window.height < this.var_1847)
         {
            this._window.height = this.var_1847;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1715;
         this._window.y = this.var_1488;
      }
