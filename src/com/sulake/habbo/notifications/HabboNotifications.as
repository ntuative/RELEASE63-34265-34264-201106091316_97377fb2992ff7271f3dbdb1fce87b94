package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1472:String = "pixelbalance";
      
      private static const const_1476:String = "badges";
      
      private static const const_1475:String = "selectbadge";
      
      private static const const_1474:String = "inventory";
      
      private static const const_1473:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1478:String = "friendlist";
      
      private static const const_1477:String = "pet_inventory";
      
      private static const const_1479:String = "go_to_room";
      ...
      private var var_368:HabboNotificationViewManager;
      ...
      private var var_969:ClubGiftNotification;
      
      private var var_968:ClubEndingNotification;
      
      private var var_972:ClubPromoNotification;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         this.var_1221.push(_loc8_);
         return this.var_1221.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1221.splice(0,1);
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_368)
         {
            this.var_368.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1472[_loc3_.data.badgeCode] = new AchievementNotification(_loc3_.data.badgeCode,_loc3_.data.achievementID,_loc3_.data.level,_loc3_.data.points,_loc3_.data.levelRewardPoints,_loc3_.data.levelRewardPointType,_loc3_.data.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_414);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1472[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1472[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      {
         this.var_368 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_970["styles"],this.var_970["view"]);
         ...
         registerUpdateReceiver(this.var_368,1);
         registerUpdateReceiver(this,2);
         this.var_414.events.addEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_414.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1137,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1137,null);
            }
         }
      }
      ...
      {
         this.addItem(param1,NotificationType.const_787,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_971.createAvatarImage(param2,AvatarScaleType.const_59);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1866,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1200)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1812,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1729)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_968 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_972 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_368.isSpaceAvailable() && this.var_1221.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_368.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1477:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_127);
               }
               break;
            case const_1473:
               break;
      ...
      {
         if(param1 != null && this.var_368 != null)
         {
            this.var_368.replaceIcon(param1);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1228,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1228,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_971.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_59);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2454)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_787,null);
            this.var_2454 = true;
      ...
      {
         if(param2.type == WindowEvent.const_194 || param2.type == WindowEvent.const_627)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_969 && this.var_969.visible)
         {
            return;
         }
         this.var_969 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_787,_loc6_);
      }
   }
}
