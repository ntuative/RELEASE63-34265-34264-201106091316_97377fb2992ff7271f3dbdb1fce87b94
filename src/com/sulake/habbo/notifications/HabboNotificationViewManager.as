package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_1536:int = 78;
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_1305,this.var_977,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_652 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = this.var_1571;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_201.length)
         {
            _loc3_ = this.var_201[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_652 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_652 + const_708;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1571 = const_1536 + param1;
         var _loc2_:int = this.var_1571;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_201.length)
         {
            _loc4_ = this.var_201[_loc3_] as HabboNotificationItemView;
            _loc4_.reposition(_loc2_);
            _loc2_ = _loc4_.verticalPosition + HabboNotificationItemView.const_652 + const_708;
            _loc3_++;
         }
      }
   }
