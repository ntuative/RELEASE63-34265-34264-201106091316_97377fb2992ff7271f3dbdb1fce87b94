package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2277:String = "hd-99999-99999";
      ...
      private var var_1890:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_350 = RenderMode.const_1823;
         ...
         this.var_116.add(AvatarType.const_126,_loc4_);
         ...
         this.var_116.add(AvatarType.const_55,_loc4_);
         ...
         this.var_793 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_318.init();
         this.var_793.init();
         _loc2_ = this.var_116.getValue(AvatarType.const_126) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_116.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_116.getValue(AvatarType.const_126) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_202.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_241 == null)
               {
                  ...
                  _loc6_ = this.var_202.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_202.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_934)
         {
            if(this.var_2544 && this.var_2543 && this.var_2542)
            {
               this.var_934 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_116.getValue(AvatarType.const_126) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1890)
         {
            this.var_1890 = new AvatarFigureContainer(this.const_2277);
         }
         this.var_241.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1890,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1712)
         {
            _loc6_ = !this.var_318.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_318.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_116.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_116.getValue(AvatarType.const_55);
      ...
      {
         var _loc3_:AvatarStructure = this.var_116.getValue(AvatarType.const_126) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_55:
               _loc3_ = this.var_116.getValue(AvatarType.const_55) as AvatarStructure;
               break;
            default:
