package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      {
         if(param1 == null || this.var_565 == null)
         {
            return;
         }
         var _loc2_:int = this.var_565.indexOf(param1);
         if(_loc2_ != -1)
         {
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_565.pop() as IPetDataListener;
         ...
         for each(_loc6_ in _loc4_)
         {
            if(this.var_1576.indexOf(_loc6_) == -1)
            {
               ...
               if(this.var_680.getValue(_loc6_) == null)
               {
                  ...
                  if(param3 != null && this.var_565.indexOf(param3) == -1)
                  {
                     this.var_565.push(param3);
                  }
               }
            }
         }
