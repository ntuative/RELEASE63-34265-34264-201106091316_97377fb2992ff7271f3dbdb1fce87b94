package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1012:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_994 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_993.width,this.var_993.height,true,0);
            _loc5_ = this.var_993.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_1012.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_994.width,this.var_994.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_994,this.var_994.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
