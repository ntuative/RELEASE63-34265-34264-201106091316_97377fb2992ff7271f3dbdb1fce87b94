package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_758:IFigurePartSet;
      ...
      private const const_2261:int = 13421772;
      
      private const const_2260:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_758 = param3;
         this._window = param1;
         this.var_1439 = this._window.findChildByTag("BG_COLOR");
         this._colors = param4;
         ...
         if(param3 != null)
         {
            ...
            {
               this.var_1768 = Math.max(this.var_1768,_loc6_.colorLayerIndex);
            }
         }
         this.var_435 = this.var_76.controller.manager.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_728 != null && !this.var_1767)
            {
               _loc3_ = this.var_728;
            }
            else
         ...
         if(this.isSelected)
         {
            this.var_1439.color = this.const_2261;
         }
         else
         {
            this.var_1439.color = this.const_2260;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:IAvatarFigureContainer = this.var_435.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
         Logger.log("QUERYING SET:" + this.partSet.type + "-" + this.partSet.id);
         if(!this.var_435.isFigureReady(_loc1_))
         {
            this.var_435.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_376[_loc6_] + "_" + FigureData.const_162;
               _loc4_ = this.var_435.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_617 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1769)
               {
                  ...
                  this.var_1769 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_617.width,this.var_617.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_617.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_617.y;
               if(this.var_1767 && _loc2_.colorLayerIndex > 0)
               {
