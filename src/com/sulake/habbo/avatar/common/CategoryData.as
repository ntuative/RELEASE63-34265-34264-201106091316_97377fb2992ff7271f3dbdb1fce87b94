package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2302:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_1108 >= 0 && this._parts.length > this.var_1108)
         {
            _loc2_ = this._parts[this.var_1108];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      {
         return this._parts[this.var_1108] as AvatarEditorGridPartItem;
      }
