package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1667:IWindowContainer;
      
      public static var var_2179:int = 6710886;
      
      private static const const_1666:int = 5000;
      
      private static const const_1500:Point = new Point(100,30);
      ...
      private var var_2963:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1376 = [];
         this.var_1497 = [AvatarEditorFigureCategory.const_907,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_296,AvatarEditorFigureCategory.const_788,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_109];
         super();
         this.var_24 = param1;
         if(var_1380 == null)
         {
         ...
         if(var_1667 == null)
         {
            ...
            var_1667 = this.var_24.manager.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         this._saveTimer = new Timer(const_1666,1);
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         if(_loc3_)
         {
            this.var_86 = this.var_24.manager.windowManager.buildFromXML(_loc3_.content as XML) as IFrameWindow;
         }
         if(this.var_86 == null)
         {
         ...
         this.var_86.position = const_1500;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_723 == null)
            {
               this.var_723 = this.var_24.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_75,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_723.addChild(this.var_62);
            }
            _loc3_ = this.var_723.getChildIndex(this.var_62);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1497);
         }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1497;
      ...
      public function update() : void
      {
         ...
         if(this.var_24.manager.sessionData && this.var_24.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_38 && (this.var_1663 == AvatarEditorSideCategory.const_109 || this.var_2963))
         {
            _loc4_ = "null";
         }
      ...
      {
         if(this.var_1663 == AvatarEditorSideCategory.const_109)
         {
            this.var_2963 = false;
            this.setSideContent(AvatarEditorSideCategory.const_481);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_481:
               break;
            case AvatarEditorSideCategory.const_633:
               _loc3_ = this.var_24.getSideContentWindowContainer(AvatarEditorSideCategory.const_633);
               break;
            case AvatarEditorSideCategory.const_109:
               _loc3_ = this.var_24.getSideContentWindowContainer(AvatarEditorSideCategory.const_109);
         }
         ...
         {
            _loc5_ = 8;
            this.var_86.content.width = this.var_62.width + _loc5_;
         }
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_340)
         {
            ...
            this.var_340 = this.var_24.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_340.procedure = this.stripClubDialogEventProc;
            this.var_340.center();
         }
         else
         {
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_24.manager.catalog.openCatalogPage(CatalogPageName.const_190,true);
         }
      }
   }
}
