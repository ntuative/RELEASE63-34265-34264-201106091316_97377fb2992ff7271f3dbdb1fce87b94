package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2061 = parseInt(param2.@ink);
         this.var_2935 = String(param2.@member);
         this.var_2936 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1646 = [];
         this.var_1647 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1646[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1647[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1646.length)
         {
            return this.var_1646[param1];
         }
         return 0;
      }
      ...
      {
         if(param1 < this.var_1647.length)
         {
            return this.var_1647[param1];
         }
         return 0;
      }
