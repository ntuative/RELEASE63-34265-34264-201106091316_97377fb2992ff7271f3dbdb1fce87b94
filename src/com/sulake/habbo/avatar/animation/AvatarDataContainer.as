package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2076:Number = 1.0;
      ...
      {
         super();
         this.var_2061 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2871 = parseInt(_loc2_,16);
         this.var_2869 = parseInt(_loc3_,16);
         ...
         this.var_821 = new ColorTransform(this.var_2080,this.var_2076,this.var_2079,this._alphaMultiplier);
         this.var_1341 = this.generatePaletteMapForGrayscale(this.var_2869,this.var_2871);
      }
      ...
      {
         return this.var_1341.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1341.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1341.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1341.getValue("alphas") as Array;
      }
