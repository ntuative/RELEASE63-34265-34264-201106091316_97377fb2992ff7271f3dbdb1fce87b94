package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2008:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1635:IAvatarImage;
      ...
      private var var_96:AvatarCanvas;
      ...
      private var var_2601:ByteArray;
      
      private var var_2600:ImageData;
      
      private var var_961:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_799 == GeometryType.const_1215 && param1 == GeometryType.const_1274 || this.var_799 == GeometryType.const_1274 && param1 == GeometryType.const_1215)
         {
            this.var_799 = param1;
            this.var_96 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_378.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_827)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_603)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1635.getFigure(),_loc5_,this.var_799,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_466 == null)
         {
            ...
            this.var_466 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_378);
            if(this.var_466 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_96)
         {
            this.var_96 = this._structure.getCanvas(this._scale,this.var_799);
            if(!this.var_96)
            {
               return null;
            }
            this.var_2599 = new Point(0,this.var_96.height - int(this.var_96.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1717[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_902 || _loc10_ == AvatarAction.const_427;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1518 = this.var_125.bodyPartId;
               this.var_196 = this.var_125.partType;
               this.var_1919 = this.var_125.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_125.flippedPartType != this.var_196)
                     {
                        this.var_196 = this.var_125.flippedPartType;
                     }
                  }
               }
               this.var_1517 = this._scale + "_" + this.var_125.action.assetPartDefinition + "_" + this.var_196 + "_" + this.var_1919 + "_" + _loc5_ + "_" + this._frame;
               this.var_455 = this._assets.getAssetByName(this.var_1517) as BitmapDataAsset;
               if(this.var_455 == null)
               {
                  this.var_1517 = this._scale + "_std_" + this.var_196 + "_" + this.var_1919 + "_" + _loc5_ + "_0";
                  this.var_455 = this._assets.getAssetByName(this.var_1517) as BitmapDataAsset;
               }
               if(!(!this.var_455 || !this.var_455.content))
               {
                  if(this.var_125.paletteMapId > -1)
                  {
                     this.var_961 = this._structure.renderManager.paletteManager.getPalette(this.var_125.paletteMapId);
                     if(this.var_961 != null)
                     {
                        this.var_1001 = this.var_455.content as BitmapData;
                        this.var_197 = new BitmapData(this.var_1001.width,this.var_1001.height);
                        this.var_2601 = this.var_961.colorize(this.var_1001.getPixels(this.var_1001.rect));
                        this.var_197.setPixels(this.var_197.rect,this.var_2601);
                     }
                     else
                     {
                        this.var_197 = (this.var_455.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1518 == AvatarBodyPartType.const_296 || this.var_1518 == AvatarBodyPartType.const_1701 || this.var_1518 == AvatarBodyPartType.const_1794) && this.var_125.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_197.colorTransform(this.var_197.rect,this.var_125.color.colorTransform);
                  }
                  if(this.var_125.isBlendable)
                  {
                     this.var_197.colorTransform(this.var_197.rect,this.var_125.blendTransform);
                  }
                  this.var_1000 = this.var_455.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_59)
                     {
                  ...
                  this.var_2600 = new ImageData(this.var_197,this.var_1000,_loc7_);
                  this.var_999.push(this.var_2600);
               }
            }
            _loc8_--;
         }
         if(this.var_999.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_999,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2599.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_59)
            {
         ...
         _loc8_ = this.var_999.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_999.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
