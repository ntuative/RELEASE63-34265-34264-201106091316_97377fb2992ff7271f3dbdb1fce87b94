package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1459:String = "Default";
      
      private static const const_1461:int = 2;
      
      private static const const_1460:String = AvatarSetType.const_41;
      ...
      protected var var_303:IActiveActionData;
      
      protected var var_1120:Boolean;
      
      protected var var_806:Array;
      ...
      protected var var_590:IAvatarDataContainer;
      ...
      private var var_2441:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1460,const_1461);
         this.var_349 = new Array();
         this.var_962 = new ActiveActionData(AvatarAction.const_383);
         this.var_962.definition = this._structure.getActionDefinition(const_1459);
         this.resetActions();
      ...
      {
         param2 += this.var_1823;
         if(param2 < AvatarDirectionAngle.const_1164)
         {
            param2 = AvatarDirectionAngle.const_335 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_335)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_628,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_270.length == 1 && this.var_101 == this.var_2069)
         {
            return this.var_101 + this.var_538 + this.var_628 % 4;
         }
         if(this.var_270.length == 2)
         {
            for each(_loc1_ in this.var_270)
            {
               ...
               {
                  _loc2_ = this.var_628 % 11;
                  return this.var_101 + "_" + this.var_2069 + this.var_538 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2443 || param2 != this.var_2442 || param1 != this.var_2441)
         {
            this.var_2443 = param3;
            this.var_2442 = param2;
            this.var_2441 = param1;
            this.var_1824 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_303.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1387 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1387)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_303.definition.geometryType,this.var_101);
         this.var_47.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_628);
         ...
         {
            if(this.var_590.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_590.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_303.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_303.definition.geometryType,this.var_101);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_628);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_349.push(new ActiveActionData(param1,param2,this.var_628));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_303 = this.var_962;
         this.var_303.definition = this.var_962.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_538 = "";
         this.var_270 = this._structure.sortActions(this.var_349);
         if(this.var_270 == null)
         {
            this.var_806 = new Array(0,0,0);
            if(this.var_1220 != "")
            {
               _loc1_ = true;
               this.var_1220 = "";
         ...
         {
            this.var_806 = this._structure.getCanvasOffsets(this.var_270,this._scale,this.var_101);
            for each(_loc4_ in this.var_270)
            {
               this.var_538 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_341)
               {
            ...
            if(this.var_1220 != this.var_538)
            {
               _loc1_ = true;
               this.var_1220 = this.var_538;
            }
         }
         this.var_1463 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_270)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_963 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1823 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_590 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_319 || _loc1_.actionType == AvatarAction.const_309 || _loc1_.actionType == AvatarAction.const_427)
               {
                  this.var_963 = true;
               }
            }
