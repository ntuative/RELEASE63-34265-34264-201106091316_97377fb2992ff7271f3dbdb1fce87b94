package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1329:IHabboWindowManager;
      ...
      private var var_289:PerformanceTracker = null;
      
      private var var_480:FramerateTracker = null;
      
      private var var_290:LatencyTracker = null;
      
      private var var_691:LagWarningLogger = null;
      
      private var var_479:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_289 = new PerformanceTracker();
         this.var_480 = new FramerateTracker();
         this.var_290 = new LatencyTracker();
         this.var_691 = new LagWarningLogger();
         this.var_479 = new ToolbarClickTracker(this);
         this.var_1591 = new Array(const_1087);
         var _loc4_:int = 0;
         while(_loc4_ < const_1087)
         {
            this.var_1591[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1841,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1723,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1788,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_954,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1288,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1329)
            {
               this.var_1329.release(new IIDHabboWindowManager());
               this.var_1329 = null;
            }
            if(this.var_333)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_355,this.onZoomToggle);
               }
            ...
            if(this.var_222)
            {
               if(!this.var_222.disposed)
               {
                  ...
                  Component(this.var_222).events.removeEventListener(HabboFriendListTrackingEvent.const_620,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_192,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_348,this.onRoomAction);
               }
      ...
      {
         this.var_1591[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_202 = IHabboConfigurationManager(param2);
         if(this.var_202)
         {
            if(this.var_290 != null)
            {
               this.var_290.configuration = this.var_202;
            }
            if(this.var_289 != null)
            {
               this.var_289.configuration = this.var_202;
            }
            ...
            if(this.var_202)
            {
               ...
               {
                  this.var_691.configure(this.var_202);
               }
               if(this.var_480 != null)
               {
                  this.var_480.configure(this.var_202);
               }
               if(this.var_479 != null)
               {
                  this.var_479.configure(this.var_202);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_924,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_871,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_69,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_649,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_289 != null)
            {
               this.var_289.connection = param1;
            }
            if(this.var_290 != null)
            {
            ...
            if(this.var_691 != null)
            {
               this.var_691.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_871)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1906);
         }
         else if(param1.type == HabboHotelViewEvent.const_649)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1752);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1831);
               break;
            case HabboCommunicationEvent.const_924:
               this.trackLoginStep(HabboLoginTrackingStep.const_1888,String(this._communication.port));
               break;
      ...
      {
         this.var_1329 = IHabboWindowManager(param2);
         if(this.var_1329)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_202)
            {
               if(this.var_202.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_202.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1591)
                  {
                  ...
                  if(this.var_289 != null)
                  {
                     _loc4_["null"] = this.var_289.flashVersion;
                     _loc4_["null"] = this.var_289.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1180);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1180,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_355,this.onZoomToggle);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_222).events.addEventListener(HabboFriendListTrackingEvent.const_620,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_620:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1288,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_954,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_192,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_348,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_333 = param2 as IAdManager;
         this.var_333.events.addEventListener(AdEvent.const_634,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_192)
         {
            if(this.var_2032 < 1)
            {
               if(!this.var_329)
         ...
         else if(param1.type == RoomEngineEvent.const_348)
         {
            if(this.var_329)
            {
               this.var_329.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_480)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_480.frameRate),_loc2_);
                  ++this.var_2032;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_479)
         {
            this.var_479.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_479)
         {
            this.var_479.track(param1.type);
         }
      }
      ...
      {
         if(this.var_202 != null && !Boolean(this.var_202.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_691.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_289 != null)
         {
            this.var_289.update(param1,this.var_571);
         }
         if(this.var_290 != null)
         {
            this.var_290.update(param1,this.var_571);
         }
         if(this.var_480 != null)
         {
            this.var_480.trackUpdate(param1,this,this.var_571);
         }
         if(this.var_691 != null)
         {
            this.var_691.update(this.var_571);
         }
      }
   }
}
