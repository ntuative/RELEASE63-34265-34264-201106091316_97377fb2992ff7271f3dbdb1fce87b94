package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_765)
         {
            this.var_765 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_765)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_764)
         {
            this.var_764 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_764)
            {
               return;
            }
