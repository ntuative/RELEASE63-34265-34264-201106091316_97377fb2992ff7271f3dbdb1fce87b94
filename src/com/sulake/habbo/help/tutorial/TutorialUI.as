package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_492:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_418:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_37.events.addEventListener(HabboHelpTutorialEvent.const_511,this.onTaskDoneEvent);
         this.var_37.events.addEventListener(HabboHelpTutorialEvent.const_521,this.onTaskDoneEvent);
         if(this.var_37.sessionDataManager != null)
         {
            this.var_37.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_328,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1379 && this.var_1378 && this.var_1664;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_37)
         {
            ...
            this.var_37.events.removeEventListener(HabboHelpTutorialEvent.const_511,this.onTaskDoneEvent);
            this.var_37.events.removeEventListener(HabboHelpTutorialEvent.const_521,this.onTaskDoneEvent);
            if(this.var_37.sessionDataManager != null)
            {
               this.var_37.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_328,this.onFigureUpdate);
            }
            this.var_37 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_53 == null || this.var_53.id == const_97)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_650:
               this.var_1664 = true;
               if(this.var_53 != null && this.var_53.id == const_492)
               {
                  this.showView(const_97);
               }
               break;
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2961 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_356:
               ...
               if(this.var_418 == null)
               {
                  this.var_418 = new NameChangeView(this);
               }
               this.var_418.showMainView();
               this.prepareForTutorial();
               break;
            case const_405:
         ...
         this._window.height = _loc2_.height + this.var_2960;
         this._window.width = _loc2_.width + this.var_2961;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_37.hideUI();
         this.var_37.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_128));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_356 || this.var_53.id == const_97))
         {
            this.showView(const_97);
         }
      }
      ...
      {
         this.var_1379 = true;
         if(this.var_53 != null && (this.var_53.id == const_405 || this.var_53.id == const_97))
         {
            this.showView(const_97);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_589)
         {
            this.var_1378 = true;
         ...
         {
            this.var_418.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_589)
         {
            this.var_418.checkedName = _loc2_.name;
         }
         else
         {
            this.var_418.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
