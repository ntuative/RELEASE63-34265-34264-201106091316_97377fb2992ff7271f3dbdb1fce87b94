package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private var var_1186:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1789 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_765)
         {
            this.var_765 = this.var_28.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_765)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_764)
         {
            this.var_764 = this.var_28.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_764)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_764.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_527;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_28.localization.registerParameter("help.tutorial.name.available","name",this.var_527);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_905:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_902:
            ...
            case ChangeUserNameResultMessageEvent.var_904:
               break;
            case ChangeUserNameResultMessageEvent.var_901:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1114 || param1 == ChangeUserNameResultMessageEvent.var_1116)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1186 = new NameSuggestionListRenderer(this.var_28);
         var _loc6_:int = this.var_1186.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_527 = this.var_28.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_28.changeName(this.var_527);
               break;
            ...
            case "header_button_close":
               this.var_28.showView(TutorialUI.const_97);
         }
      }
