package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_781:FaqCategory;
      
      private var var_780:FaqCategory;
      ...
      {
         super();
         this.var_781 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_780 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_779 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_781.hasItem(param1))
         {
            this.var_781.getItem(param1).answerText = param2;
         }
         if(this.var_780.hasItem(param1))
         {
            this.var_780.getItem(param1).answerText = param2;
         }
         if(this.var_779.hasItem(param1))
         {
            this.var_779.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_781.hasItem(param1))
         {
            return this.var_781.getItem(param1);
         }
         if(this.var_780.hasItem(param1))
         {
            return this.var_780.getItem(param1);
         }
         if(this.var_779.hasItem(param1))
         {
            return this.var_779.getItem(param1);
         }
         var _loc2_:int = 0;
