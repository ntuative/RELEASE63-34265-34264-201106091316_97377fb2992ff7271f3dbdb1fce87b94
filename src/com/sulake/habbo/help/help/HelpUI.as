package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2146:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106091311));
         this.var_138 = new Map();
         this.var_138.add(HabboHelpViewEnum.const_1945,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_215,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_607,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_331,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_306,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_393,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_138.add(HabboHelpViewEnum.const_307,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_138.add(HabboHelpViewEnum.const_1136,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_138.add(HabboHelpViewEnum.const_1214,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_981,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_307:
               this.showUI(HabboHelpViewEnum.const_307);
               break;
            case CallForHelpResultEnum.const_1366:
               this.showUI(HabboHelpViewEnum.const_1214);
               break;
            case CallForHelpResultEnum.const_1158:
               this.showUI(HabboHelpViewEnum.const_1136);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_138.getValue(HabboHelpViewEnum.const_215) as IHelpViewController;
      ...
      private function createWindow() : void
      {
         ...
         this.var_2961 = this._window.width - _loc3_.width;
         this.var_2960 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2960;
         this._window.width = _loc1_.width + this.var_2961;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_417 == HabboHelpViewEnum.const_215)
         {
            return;
         }
         if(this.var_722.length < 2)
         {
            ...
            this.var_722.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_722[1],this.var_722[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_722[0],this.var_722[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_417 == HabboHelpViewEnum.const_215 || this.var_588.length == 0)
         {
            return;
         }
         if(this.var_416 == null)
