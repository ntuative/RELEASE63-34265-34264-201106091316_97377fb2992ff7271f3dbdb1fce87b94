package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends HelpViewController
   {
      ...
      private static const const_1543:int = 60;
      ...
      override public function render() : void
      {
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1543)
         {
      ...
      private function onCallForHelp(param1:WindowMouseEvent) : void
      {
         ...
         main.showUI(HabboHelpViewEnum.const_393);
      }
      
      private function onReportUser(param1:WindowMouseEvent) : void
      {
         main.component.callForHelpData.reportedUserId = 0;
         main.showUI(HabboHelpViewEnum.const_981);
      }
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            main.showUI(HabboHelpViewEnum.const_306);
            main.tellUI(HabboHelpViewEnum.const_306,_loc6_);
         }
      }
   }
}
