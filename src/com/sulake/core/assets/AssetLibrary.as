package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1325:String = "AssetLibraryReady";
      
      public static const const_769:String = "AssetLibraryLoaded";
      
      public static const const_1784:String = "AssetLibraryUnloaded";
      
      public static const const_1781:String = "AssetLibraryLoadError";
      
      private static const const_665:String = "name";
      
      private static const const_1026:String = "asset";
      
      private static const const_1025:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1027:String = "library";
      
      private static var var_309:Dictionary;
      
      private static var var_1749:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_517:uint = 0;
      
      private static var var_932:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_516 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_610 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1027);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1026);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_665);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1025);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_610 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_932.splice(var_932.indexOf(this),1);
            --var_517;
            this.var_516 = null;
            this.var_931 = null;
            this.var_167 = null;
      ...
      {
         if(this.var_610 == param1.url && this.var_934)
         {
            if(!this.var_933 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_611);
            }
            this.var_933 = param2;
      ...
      public function unload() : void
      {
         ...
         this.var_934 = false;
         this.var_610 = null;
         dispatchEvent(new Event(AssetLibrary.const_1784));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_516[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1152,this.assetLoadEventHandler);
         ...
         this.var_516[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_516[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_516[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_167[param1] != null || (this.var_611 != null ? this.var_611[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1749.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_309.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_309[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_309[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_309)
            {
               _loc3_ = AssetTypeDeclaration(var_309[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_309)
            {
               _loc4_ = AssetTypeDeclaration(var_309[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_610 = _loc2_.url;
         if(this.var_933)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_611);
         }
         this.var_934 = true;
         dispatchEvent(new Event(AssetLibrary.const_769));
         dispatchEvent(new Event(AssetLibrary.const_1325));
         if(this.var_933)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1027);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1026);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_665) && _loc3_.attribute(const_665).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_610 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_611[param1]);
                     _loc6_ = _loc3_.child(const_1025);
