package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_599:uint = 0;
      ...
      private var var_1718:AssetTypeDeclaration;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_118 is BitmapDataAsset)
         {
            ...
            this.var_1585 = BitmapDataAsset(this.var_118).var_1585;
            this.var_1584 = BitmapDataAsset(this.var_118).var_1584;
            if(this._bitmap != null)
            {
               this.var_118 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1585 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1584 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
