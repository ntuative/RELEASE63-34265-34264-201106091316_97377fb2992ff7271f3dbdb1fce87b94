package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1123 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_45 = new Loader();
         this.var_1124 = new LoaderContext();
         this.var_1124.checkPolicyFile = true;
         ...
         {
            this.var_45.load(param2,this.var_1124);
         }
      }
      ...
      {
         this.var_1123 = param1.url;
         var_351 = 0;
         this.var_45.load(param1,this.var_1124);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_351 < var_2992)
            {
               ...
               this.var_45.load(new URLRequest(this.var_1123 + (this.var_1123.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_351),this.var_1124);
               return true;
            }
         }
         return false;
