package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1556:String = "asset-libraries";
      
      private static const const_1557:String = "library";
      
      private static const const_1559:String = "service-libraries";
      
      private static const const_1560:String = "library";
      
      private static const const_1558:String = "component-libraries";
      
      private static const const_1554:String = "library";
      
      private static const const_1553:String = "error_data";
      
      private static const const_1555:String = "error_cat";
      
      private static const const_1552:String = "error_desc";
       
      
      private var var_401:LibraryLoaderQueue;
      
      private var var_859:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_424.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            ...
            case Core.const_892:
               ...
               var_424.addChild(new ProfilerViewer(this.var_224));
               break;
            case Core.const_569:
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            if(var_424)
            {
               var_424.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
               var_424 = null;
            }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1553,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1555,String(param3));
         ErrorReportStorage.setParameter(const_1552,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_859 = loadingEventDelegate;
         if(this.var_401 == null)
         {
         ...
         try
         {
            node = config.child(const_1556)[0];
            if(node != null)
            {
               list = node.child(const_1557);
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_202,e);
         }
         try
         {
            node = config.child(const_1559)[0];
            if(node != null)
            {
               list = node.child(const_1560);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_202,e);
         }
         try
         {
            node = config.child(const_1558)[0];
            if(node != null)
            {
               list = node.child(const_1554);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_202,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1323);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_859)
         {
            this.var_859.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_859)
         {
            ...
            this.var_859.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_859)
                  {
                     this.var_859.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_573 - this.var_401.length,this.var_573,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_224 ? 0 : this.var_1594 & 0;
         if(_loc3_ == Core.const_569)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var maxTimePerFrame:uint = 1000 / var_424.stage.frameRate;
         priority = 0;
         while(priority < CoreComponentContext.const_106)
         {
            t = getTimer();
