package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1987:uint = 1;
      
      protected static const const_1988:uint = 2;
      
      protected static const const_1986:uint = 4;
      
      protected static const const_1985:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1902:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1163:Boolean = false;
      
      public static const const_1775:int = 2;
      
      private static var var_1110:Array = new Array();
      ...
      protected var var_1406:int;
      
      protected var var_1407:int;
      
      protected var var_3058:uint = 0;
      
      protected var var_2999:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1163)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_899[_loc2_] as LibraryLoader;
            ...
            while(var_899.length < const_1775 && false)
            {
               _loc1_ = var_1110.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1130 ? uint(this.var_1406 - this.var_2221) : uint(getTimer() - this.var_2221);
      }
      ...
      {
         if(this.var_1131 && !_disposed)
         {
            this.var_1131 = false;
            if(!this.var_1130 && this.var_261)
            {
               this.var_1406 = -1;
      ...
      {
         if(!this.var_1130 && !_disposed && this.var_1407 > 0)
         {
            try
            {
               this.var_45.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_261,const_1902 - this.var_1407);
            if(this.var_2999)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_505 = LibraryLoader.name_4;
         ...
         if(this.var_505 == LibraryLoader.const_1985)
         {
         ...
         if(this.var_505 == LibraryLoader.name_4)
         {
