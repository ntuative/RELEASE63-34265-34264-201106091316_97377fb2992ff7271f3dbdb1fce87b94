package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1965:String = "bool";
      ...
      private static const const_2015:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_272 || _loc5_ == const_166)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1924:
               return Number(param1);
            case const_37:
               return param1 == const_694 || int(param1) > 0;
            case const_1965:
               return param1 == const_694 || int(param1) > 0;
            case const_152:
               return uint(param1);
            case const_166:
               return param1.split(const_1542);
            default:
