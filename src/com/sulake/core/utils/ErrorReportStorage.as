package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1369:Map = new Map();
      
      private static var var_888:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         var _loc1_:String = "";
         var _loc2_:int = 0;
         while(_loc2_ < var_888.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_888.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_888.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_888.remove(param1);
         var_888.add(param1,param2);
      }
      ...
      {
         return var_1369[param1];
      }
      
      public static function getParameterNames() : Array
      {
         return var_1369.getKeys();
      }
   }
}
