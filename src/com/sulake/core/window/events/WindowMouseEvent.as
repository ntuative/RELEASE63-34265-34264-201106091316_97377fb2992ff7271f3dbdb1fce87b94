package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_2204:String = "WME_MIDDLE_CLICK";
      
      public static const const_2082:String = "WME_MIDDLE_DOWN";
      ...
      public static const const_245:String = "WME_UP_OUTSIDE";
      
      public static const const_327:String = "WME_WHEEL";
      
      public static const const_2061:String = "WME_RIGHT_CLICK";
      
      public static const const_2220:String = "WME_RIGHT_DOWN";
      
      public static const const_2078:String = "WME_RIGHT_UP";
      
      public static const const_1959:String = "WME_ROLL_OUT";
      
      public static const const_1944:String = "WME_ROLL_OVER";
      
      public static const const_2107:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_726 = param3;
         _loc13_.var_506 = false;
         _loc13_.var_727 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_495 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
