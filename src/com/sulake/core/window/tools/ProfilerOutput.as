package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1660:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1659:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_184:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3032 = new Array();
         this.var_184 = this.profiler;
         this._windowManager = param2;
         this.var_1080 = param3;
         var _loc4_:ByteArray = new var_1660() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_184)
         {
            this.var_184.removeStopEventListener(this.refresh);
            this.var_184 = null;
         }
         if(!this.var_184 && param1)
         {
            this.var_184 = param1;
            this.var_184.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_518)
            {
               this.var_2138 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_184.getProfilerAgentsInArray();
         ...
         if(this.var_2138)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_184.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_184.numBitmapAssetInstances + " / " + this.var_184.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_1080.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_184.numTrackedBitmapDataInstances + " / " + this.var_184.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1659() as ByteArray;
