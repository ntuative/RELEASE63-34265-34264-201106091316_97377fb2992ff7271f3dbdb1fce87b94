package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1377:Dictionary = createPropertySetterTable();
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_472,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_472 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_472,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_809 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_472);
      }
      ...
      {
         this.var_913 = param1;
         this._field.scrollH = this.var_913 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_913 * this.maxScrollH,this.var_594 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_472);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_846,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1353));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1199 ? new PropertyStruct(PropertyDefaults.const_987,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1186) : PropertyDefaults.const_1685);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1146 ? new PropertyStruct(PropertyDefaults.const_1318,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1272) : PropertyDefaults.const_1672);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_904) ? new PropertyStruct(PropertyDefaults.const_395,this._field.textColor,PropertyStruct.const_152,true) : PropertyDefaults.const_1251);
         _loc1_.push(this.var_472 != TextStyleManager.const_206 ? new PropertyStruct(PropertyDefaults.const_435,this.var_472,PropertyStruct.const_51,true,PropertyDefaults.const_866) : PropertyDefaults.const_1232);
         _loc1_.push(this.var_43.left != PropertyDefaults.const_793 ? new PropertyStruct(PropertyDefaults.const_298,this.var_43.left,PropertyStruct.const_40,true) : PropertyDefaults.const_854);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_941 ? new PropertyStruct(PropertyDefaults.const_301,this.var_43.top,PropertyStruct.const_40,true) : PropertyDefaults.const_889);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_783 ? new PropertyStruct(PropertyDefaults.const_263,this.var_43.right,PropertyStruct.const_40,true) : PropertyDefaults.const_852);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_863 ? new PropertyStruct(PropertyDefaults.const_254,this.var_43.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_990);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1133 ? new PropertyStruct(PropertyDefaults.const_930,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1808);
