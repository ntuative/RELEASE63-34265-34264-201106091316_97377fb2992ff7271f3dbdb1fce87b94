package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1674:uint = 500;
      
      protected var var_1398:String = "";
      
      protected var var_1386:Boolean = false;
      
      protected var var_757:Boolean = false;
      ...
      {
         this.var_1398 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_757 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_229,event,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_896,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1690);
         _loc1_.push(this.var_1386 != PropertyDefaults.const_1209 ? new PropertyStruct(PropertyDefaults.const_755,this.var_1386,PropertyStruct.const_37,true) : PropertyDefaults.const_1713);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1255 ? new PropertyStruct(PropertyDefaults.const_756,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1929);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1363 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1813);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_896:
                  ...
                  break;
               case PropertyDefaults.const_1223:
