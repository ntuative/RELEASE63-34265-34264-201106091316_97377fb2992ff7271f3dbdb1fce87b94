package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_472);
         if(_loc1_)
         {
      ...
      {
         if(this.var_472 != param1.name)
         {
            this.var_472 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2764 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_393 != _loc2_.color : this.var_393 != null && this.var_393 != PropertyDefaults.const_904) ? new PropertyStruct(PropertyDefaults.const_395,this.var_393,PropertyStruct.const_152,true) : PropertyDefaults.const_1251);
         if(this.var_43)
         {
            if(this.var_43.left != PropertyDefaults.const_793)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_298,this.var_43.left,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_854);
            }
            if(this.var_43.top != PropertyDefaults.const_941)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_301,this.var_43.top,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_889);
            }
            if(this.var_43.right != PropertyDefaults.const_783)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_263,this.var_43.right,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_852);
            }
            if(this.var_43.bottom != PropertyDefaults.const_863)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_254,this.var_43.bottom,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_990);
            }
         }
         else
         {
