package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1006:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1941:StyleSheet = null;
      ...
      {
         this.var_809 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      {
         if(PropertyDefaults.const_893.indexOf(param1) > -1)
         {
            this.var_809 = param1;
         }
      }
      ...
      {
         return this.var_809 == LinkTarget.const_30 ? defaultLinkTarget : this.var_809;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1941;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1249)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_809 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_899,this.var_809,PropertyStruct.const_51,true,PropertyDefaults.const_893));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_899)
            {
               this.var_809 = _loc2_.value as String;
               break;
            }
