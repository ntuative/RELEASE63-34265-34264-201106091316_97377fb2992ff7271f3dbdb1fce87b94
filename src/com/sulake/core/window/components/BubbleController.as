package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2032:String = "_POINTER_DOWN";
      
      private static const const_2031:String = "_POINTER_LEFT";
      
      private static const const_2030:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_760,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1673);
         }
         return _loc1_;
      }
