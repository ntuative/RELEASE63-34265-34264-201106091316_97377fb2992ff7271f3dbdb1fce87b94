package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_371)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1134)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_908;
         if(this.var_908 != param1)
         {
            if(this.var_908 != null)
            {
               if(!this.var_908.disposed)
               {
                  this.var_908.deactivate();
               }
            }
            this.var_908 = param1;
