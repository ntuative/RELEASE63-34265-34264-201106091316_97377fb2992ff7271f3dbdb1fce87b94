package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_628)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_628)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_832,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1909);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1369)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_996,param1.toolTipDelay,PropertyStruct.const_295,true));
         }
         else
         {
      ...
      {
         this.var_1398 = param1 == null ? "null" : param1;
      }
