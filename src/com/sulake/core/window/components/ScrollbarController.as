package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1501:String = "increment";
      
      private static const const_1502:String = "decrement";
      
      private static const const_1063:String = "slider_track";
      
      private static const const_676:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_733:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_187 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_488;
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_991 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return this.track.findChildByName(const_676) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_676:
               if(param2.type == WindowEvent.const_227)
               {
                  if(!this.var_1252)
                  {
                     if(this._horizontal)
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_327)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_733;
                  }
                  else
                  {
                     this.scrollV -= this.var_733;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_911)
         {
            ...
            else if(param2.name == const_1502)
            {
               if(this.var_19)
               {
                  this.var_1252 = true;
            ...
            else if(param2.name == const_1063)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_676).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_327)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_991) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_991) as IScrollableWindow;
               if(_loc1_)
               {
