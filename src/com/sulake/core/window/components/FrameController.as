package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1499:String = "_TITLE";
      
      private static const const_1532:String = "_HEADER";
      
      private static const const_1530:String = "_CONTENT";
      
      private static const const_1531:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1564:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1499) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1564 = findChildByTag(const_1532) as IHeaderWindow;
            if(!this.var_1564)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_198 = findChildByTag(const_1530) as IWindowContainer;
            if(!this.var_198)
            {
      ...
      {
         return findChildByTag(const_1531) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1379,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1130 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_365);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_259);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_290);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_369,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_298,_loc3_.left,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_301,_loc3_.top,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_263,0 - _loc3_.right,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_254,0 - _loc3_.bottom,PropertyStruct.const_40,_loc2_));
         return _loc1_;
      }
