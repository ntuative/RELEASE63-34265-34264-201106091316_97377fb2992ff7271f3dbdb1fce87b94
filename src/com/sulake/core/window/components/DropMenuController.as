package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_457:String = "_DROPMENU_TITLETEXT";
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_357,this,null,true);
      ...
      {
         return getChildByName(DropMenuController.const_457) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_199 == null || this.var_199.disposed)
         {
            this.var_199 = context.create(name + "::submenu","",WindowType.const_529,var_87,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1007 = false;
            this.getTitleLabel().text = this.var_656 < this.var_281.length && this.var_656 > -1 ? this.var_281[this.var_656] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_642,var_87,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_385,var_87,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         {
            _loc4_.getListItemAt(this.var_656).setStateFlag(WindowState.const_58,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_911)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1289:
            case WindowMouseEvent.const_57:
               ...
               break;
            case WindowTouchEvent.const_947:
      ...
      public function open() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1751,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_281.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_730,this.var_281,PropertyStruct.const_166,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_730)
            {
