package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_457:String = "_BTN_TEXT";
      
      protected static const const_1375:Number = 0.5;
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_457);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_246:
                  try
                  {
                     getChildByName(const_457).blend = getChildByName(const_457).blend + const_1375;
                  }
                  catch(e:Error)
                  {
                  }
                  break;
               case WindowEvent.const_287:
                  try
                  {
                     getChildByName(const_457).blend = getChildByName(const_457).blend - const_1375;
                  }
