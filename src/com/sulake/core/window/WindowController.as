package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1343:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1379:String = "_COLORIZE";
      
      protected static const const_1378:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1101:Point = new Point();
      ...
      protected var var_187:Boolean = true;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_408 = new Rectangle();
         if(_loc12_ != null)
         {
            var_423 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_68 = var_423.clone();
            var_11 = var_423.clone();
         ...
         if(_loc13_)
         {
            ...
            var_502 = _loc13_.var_2974;
            if(var_503 != _loc13_.background)
            {
      ...
      {
         var_503 = param1;
         var_260 = !!var_503 ? uint(var_260 | var_597) : uint(var_260 & 16777215);
         this.var_187 = this.var_187 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_260 = !!var_503 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      ...
      {
         var_597 = param1 << 24;
         var_260 = !!var_503 ? uint(var_597 | var_260) : uint(16777215 & var_260);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1360);
      }
      ...
      {
         var_502 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_903);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_87)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1378) == -1)
               {
                  _loc4_.style = var_87;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_408 = this._parent.rectangle.clone();
               var_68.x = var_11.x;
               var_68.y = var_11.y;
               var_68.width = var_11.width;
               var_68.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_487,this,this._parent);
            ...
            else
            {
               this.var_408.x = 0;
               this.var_408.y = 0;
               this.var_408.width = 0;
               this.var_408.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1744,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_87,var_21,_context,var_11,null,this.var_736,this.properties,var_916.concat(),_id) as WindowController;
         _loc2_.var_502 = var_502;
         _loc2_.var_187 = this.var_187;
         _loc2_._debug = this._debug;
         _loc2_.var_408 = this.var_408.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_423 = var_423.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2872 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_550)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_547)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_21 & 0);
            if(_loc7_ == WindowParam.const_528)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_636)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1189,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_910))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_43:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1320;
                  if(testParamFlag(WindowParam.const_449))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_266))
                        {
                  ...
                  if((var_21 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_365))
                        {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_39:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_917,this,null);
                     ...
                     else if(testParamFlag(WindowParam.const_222,WindowParam.const_178))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_553))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_21 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_183,this._parent,this);
               ...
               case WindowEvent.const_436:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1845,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_227,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_560:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1134,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_371,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_917:
                  this._parent.getRegionProperties(null,this.var_408);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_502);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_502);
      }
         ...
         if(this.var_187 && var_502 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1101,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1101,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_87 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1378) == -1)
               {
                  _loc6_.style = var_87;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_161,WindowParam.const_188);
         var _loc2_:* = !testParamFlag(WindowParam.const_154,WindowParam.const_178);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_408.width;
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_450)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_451)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_408.height;
               _loc5_ = uint(var_21 & 0);
      ...
      {
         if(_state == WindowState.const_597)
         {
            return true;
         }
         _state = WindowState.const_597;
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_325,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function maximize() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_76,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1737,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_557,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_936,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_287,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1342 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1342 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_394,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
