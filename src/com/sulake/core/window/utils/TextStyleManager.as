package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_692:String = "{";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_98[const_206],var_98[ITALIC],var_98[BOLD]];
            var_98.reset();
            var_98[const_206] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_693);
         if(countSubStrings(param1,const_692) != countSubStrings(param1,const_693))
         {
            throw new Error("Mismatching amount of \"" + const_692 + "\" versus \"" + const_693 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1575) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1574) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_692)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
