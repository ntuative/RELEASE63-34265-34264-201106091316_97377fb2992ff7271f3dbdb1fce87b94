package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1334:String = "_EXCLUDE";
      
      public static const const_2111:String = "_INCLUDE";
      
      public static const const_2124:String = "_TEMP";
      
      private static const const_1577:String = "layout";
      
      private static const const_1095:String = "window";
      
      private static const const_1096:String = "variables";
      
      private static const const_1097:String = "filters";
      
      private static const const_665:String = "name";
      
      private static const const_1583:String = "style";
      
      private static const const_695:String = "params";
      ...
      private static const const_1586:String = "visible";
      
      private static const const_1580:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1360:String = "blend";
      
      private static const const_1582:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1585:String = "treshold";
      
      private static const const_1581:String = "children";
      
      private static const const_1579:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1576:String = "height_min";
      
      private static const const_1589:String = "height_max";
      
      private static const const_694:String = "true";
      
      private static const const_181:String = "0";
      
      private static const const_1578:String = "$";
      
      private static const const_1542:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1587:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1584:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1128:Dictionary;
      
      protected var var_1675:Dictionary;
      
      protected var var_2211:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1401,this.var_1402);
         this.var_1128 = new Dictionary();
         this.var_1675 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1128,this.var_1675);
         this.var_2211 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1584,const_50);
         return param1.replace(const_1587,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1128)
            {
               delete this.var_1128[_loc1_];
            }
            for(_loc1_ in this.var_1675)
            {
               delete this.var_1675[_loc1_];
            }
            this.var_2211.dispose();
            this.var_2211 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1577)
         {
            _loc8_ = param1.child(const_1096);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1097).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1095);
         ...
         if(param1.localName() == const_1095)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1401[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_665,variables,"")));
         style = uint(this.parseAttribute(xml,const_1583,variables,style));
         params = uint(this.parseAttribute(xml,const_695,variables,params));
         ...
         visible = this.parseAttribute(xml,const_1586,variables,visible.toString()) == const_694;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_695).length() > 0)
         {
            list = xml.child(const_695).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_665,variables,"") as String;
               if(this.var_1128[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_665)) + "\"!");
               }
               params |= this.var_1128[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1580,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1542);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1096)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1579,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1576,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1589,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_694;
         blend = Number(this.parseAttribute(xml,const_1360,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1582,variables,window.clipping.toString()) == const_694;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1585,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1097).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1402[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1334) == -1)
                  {
