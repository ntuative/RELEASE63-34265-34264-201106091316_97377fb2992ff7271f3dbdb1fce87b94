package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_725:Point;
      
      protected var var_186:WindowController;
      ...
      protected var var_906:IWindowContextStateListener;
      ...
      {
         super();
         this.var_725 = new Point();
         if(var_352 == null)
         {
            var_352 = new Array();
            var_352[0] = MouseCursorType.const_336;
            var_352[1] = MouseCursorType.const_30;
            var_352[2] = MouseCursorType.const_336;
            var_352[3] = MouseCursorType.const_336;
            var_352[4] = MouseCursorType.const_336;
            var_352[5] = MouseCursorType.const_30;
            var_352[6] = MouseCursorType.const_336;
         }
         if(var_307 == null)
         {
            var_307 = new Array();
            var_307[0] = WindowState.const_93;
            var_307[1] = WindowState.const_91;
            var_307[2] = WindowState.const_87;
            var_307[3] = WindowState.const_76;
            var_307[4] = WindowState.const_58;
            var_307[5] = WindowState.const_99;
            var_307[6] = WindowState.const_88;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_245;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1381 as WindowController;
         this.var_186 = state.var_1382 as WindowController;
         this.var_185 = state.renderer;
         this.var_906 = state.var_1383;
         eventQueue.begin();
         this.var_725.x = -1;
         this.var_725.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_725.x || event.stageY != this.var_725.y)
            {
               this.var_725.x = event.stageX;
               this.var_725.y = event.stageY;
               array = new Array();
               this.var_93.groupParameterFilteredChildrenUnderPoint(this.var_725,array,WindowParam.const_31);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_906.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1381 = this.var_71;
         state.var_1382 = this.var_186;
         state.renderer = this.var_185;
         state.var_1383 = this.var_906;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param2.type == MouseEvent.MOUSE_UP)
         {
            ...
            {
               if(this.var_186 && !this.var_186.disposed)
               {
                  this.var_186.update(this.var_186,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_186,param1));
                  this.var_186 = null;
                  if(param1.disposed)
                  {
                     return null;
