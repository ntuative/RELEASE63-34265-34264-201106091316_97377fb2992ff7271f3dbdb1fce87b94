package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_105:String = "HabboFriendListCom_popup_arrow_right_png";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_346 = SkinLayoutEntity.const_526;
                  break;
               case "move":
                  _loc5_.var_346 = SkinLayoutEntity.const_345;
                  break;
               case "strech":
                  _loc5_.var_346 = SkinLayoutEntity.const_608;
                  break;
               case "tiled":
                  _loc5_.var_346 = SkinLayoutEntity.const_329;
                  break;
               case "center":
                  _loc5_.var_346 = SkinLayoutEntity.const_536;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_345 = SkinLayoutEntity.const_526;
                  break;
               case "move":
                  _loc5_.var_345 = SkinLayoutEntity.const_345;
                  break;
               case "strech":
                  _loc5_.var_345 = SkinLayoutEntity.const_608;
                  break;
               case "tiled":
                  _loc5_.var_345 = SkinLayoutEntity.const_329;
                  break;
               case "center":
                  _loc5_.var_345 = SkinLayoutEntity.const_536;
            }
         }
