package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2080:uint = 64;
      
      public static const const_2087:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_598:uint = 0;
      
      protected static var var_353:uint = 0;
       
      
      protected var var_231:DisplayObjectContainer;
         ...
         if(this.var_907)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_353 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2197,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2197,16777215);
                  }
                  var_353 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_907)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_353 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_231 == null)
         {
            ...
            this.var_231.name = this.name + " - Child Container";
            this.var_231.mouseEnabled = false;
            addChild(this.var_231);
         }
         return this.var_231;
      }
      ...
      {
         return this.var_231 != null ? int(this.var_231.numChildren) : 0;
      }
