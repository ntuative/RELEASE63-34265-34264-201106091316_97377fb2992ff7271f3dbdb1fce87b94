package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_1125:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1658 = 4294967295;
         this.var_1104 = 0;
         this.var_821 = new ColorTransform();
         this.var_1121 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1125) : uint(const_706);
         var _loc6_:Boolean = this.var_205.width > 0 && this.var_205.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1104))
            {
               _loc5_ = const_1126;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_1126)
               {
                  ...
                  if(this.var_719)
                  {
                     ...
                     _loc7_.draw(param1,this.var_137,this.var_137.rect,this.var_1104,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1121.tx = param2.x;
                     this.var_1121.ty = param2.y;
                     this.var_821.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_137,this.var_1121,this.var_821,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            ...
            {
               _loc2_ = this._skinContainer.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_139);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1658;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_903:
               this.var_1104 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1104 != this.var_1658)
               {
                  this.var_719 = true;
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1360:
               ...
               break;
            case WindowRedrawFlag.const_1171:
               _loc4_ = true;
         }
         if(_loc4_)
         {
