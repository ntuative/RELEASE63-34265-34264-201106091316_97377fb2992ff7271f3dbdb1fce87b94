package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1463:String = "skin";
      
      private static const const_1465:String = "bitmap";
      
      private static const const_1467:String = "fill";
      
      private static const const_1462:String = "text";
      
      private static const const_1466:String = "label";
      
      private static const const_1464:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "UnignoreUserMessageComposer";
      ...
      private var var_2450:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1827,this.var_2449);
         this.var_2448 = new Dictionary();
         this.var_2450 = new Dictionary();
         StateCodeTable.fillTables(this.var_2448,this.var_2450);
         this.var_444 = new Dictionary();
         this.var_444[const_1463] = BitmapSkinRenderer;
         this.var_444[const_1465] = BitmapDataRenderer;
         this.var_444[const_1467] = FillSkinRenderer;
         this.var_444[const_1462] = TextSkinRenderer;
         this.var_444[const_1466] = LabelRenderer;
         this.var_444[const_1464] = ShapeSkinRenderer;
         this.var_444[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_444[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_354 == null)
         {
            var_354 = new Array();
            var_354.push(WindowState.const_76);
            var_354.push(WindowState.const_88);
            var_354.push(WindowState.const_99);
            var_354.push(WindowState.const_58);
            var_354.push(WindowState.const_87);
            var_354.push(WindowState.const_91);
            var_354.push(WindowState.const_93);
            var_354.push(WindowState.const_105);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2974 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1827[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_966[param1] = new Array(const_1052);
         }
         this.var_966[param1][param2] = param3;
         if(this.var_965[param1] == null)
         {
            this.var_965[param1] = new Array(const_1052);
         }
