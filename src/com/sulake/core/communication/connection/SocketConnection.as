package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1814:int = 10000;
      ...
      private var var_579:ByteArray;
      
      private var var_1353:IEncryption;
      
      private var var_876:IProtocol;
      
      private var _id:String;
      
      private var var_1354:IMessageClassManager;
      
      private var var_294:ICoreCommunicationManager;
      
      private var var_580:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_294 = param2;
         this.var_579 = new ByteArray();
         this.var_1354 = new MessageClassManager();
         this.var_83 = new Socket();
         this.var_225 = new Timer(const_1814,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_580)
         {
            this.var_580.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_225.start();
         this.var_877 = getTimer();
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_294.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1354.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         if(this.var_580)
         {
            this.var_580.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1353 != null)
         {
            _loc3_ = this.var_1353.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1354.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1353 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_876.getMessages(this.var_579,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_580)
               {
                  this.var_580.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1354.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_579,offset);
               this.var_579 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_579.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_579.writeByte(this.var_83.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_225.stop();
         this.var_2093 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_877));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2093 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_877));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_877));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_877));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_877));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_877));
